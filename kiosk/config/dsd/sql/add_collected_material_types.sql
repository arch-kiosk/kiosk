...
select 'small_find', 'small find', 'small_find', 'collected_material', now(), now(), 'sys'
...
insert into {{collected_material_types}}(id, name, layout_name, created,
                                     modified, modified_by)
select 'bulk', 'bulk', 'collected_material', now(), now(), 'sys'
    from (select count(uid) c from {{collected_material_types}} where id='bulk') t where t.c=0;

insert into {{collected_material_types}}(id, name, layout_name, created,
                                     modified, modified_by)
select 'sample', 'sample', 'collected_material', now(), now(), 'sys'
