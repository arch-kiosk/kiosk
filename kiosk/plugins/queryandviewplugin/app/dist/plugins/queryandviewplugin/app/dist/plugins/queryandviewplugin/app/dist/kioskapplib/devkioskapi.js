import { KioskApi, FetchException, API_STATE_ERROR, API_STATE_INITIALIZING, API_STATE_READY, API_STATE_UNINITIALZED, } from "./kioskapi";
export class DevKioskApi extends KioskApi {
    constructor() {
        super(...arguments);
        this.token = "";
        this.lastErrorMessage = "";
        this.kioskRoutes = null;
        this.status = API_STATE_UNINITIALZED;
    }
    getKioskRoute(routeName) {
        if (!this.kioskRoutes) {
...
//# sourceMappingURL=devkioskapi.js.map
//# sourceMappingURL=devkioskapi.js.map
//# sourceMappingURL=devkioskapi.js.map