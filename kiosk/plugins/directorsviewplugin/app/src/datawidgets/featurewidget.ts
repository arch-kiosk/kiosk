...
import local_css from '../styles/component-feature-widget.sass?inline';
import {State} from "../store/reducer";
import {store} from '../store/store';
import {setSelector, StoreContextSelector, StoreDateSelector, StoreTeamSelector} from '../store/actions';
...
class FeatureWidget extends KioskStoreAppComponent {
