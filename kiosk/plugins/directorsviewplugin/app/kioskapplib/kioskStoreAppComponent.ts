...
//Because this is using redux we can't use the normal KioskAppComponent from @arch-kiosk/kiosktsapplib
export abstract class KioskStoreAppComponent extends connect(store) (LitElement){
    // @ts-ignore
