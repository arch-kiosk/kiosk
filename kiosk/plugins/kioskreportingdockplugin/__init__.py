...
import kioskglobals
from .kioskreportingdock import KioskReportingDock
...
if "mcpcore.mcpworker" not in sys.modules:
    ...
    from .kioskreportingdockcontroller import kioskreportingdock
    from .kioskreportingdockcontroller import plugin_version, init_controller
