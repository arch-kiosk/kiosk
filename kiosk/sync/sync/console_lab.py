...
def select_query_in_memory(dsd, urapdb_with_records):
    context_data = {
        "context_name": {
            "type": "some type",
            "scope": {
    ...
    sql_source = context.select(identifier="CC", field_or_instruction="replfield_uuid()",
...
if __name__ == "__main__":
    ...
    select_query_in_memory(dsd, KioskSQLDb)