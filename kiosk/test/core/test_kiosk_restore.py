...
class TestKioskRestore(KioskPyTestHelper):
    ...
    @pytest.fixture(autouse=False)  # scope session gives this fixture priority over module scope
    ...
    def test_transfer_record_by_record(self, init_test, config):
        assert init_done
    ...
    def test_add_base_path_if_necessary(self, shared_datadir):
        assert KioskRestore.add_base_path_if_necessary(shared_datadir, os.path.join(shared_datadir, "test_kiosk_config.yml"))