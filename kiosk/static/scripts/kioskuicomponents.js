...
var $d = (n, t, e) => t in n ? Rd(n, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : n[t] = e;
var ye = (n, t, e) => $d(n, typeof t != "symbol" ? t + "" : t, e);
/**
 * @license
...
function ct(n) {
  ...
  if (!t)
    ...
    const e = t.version;
    e && n.version && e === n.version ? console.warn(`The component ${n.is} has been loaded twice`) : console.error(
      `Tried to define ${n.is} version ${n.version} when version ${t.version} is already in use. Something will probably break.`
    );
  }
}
/**
 ...
 */
const Vi = globalThis, Qo = Vi.ShadowRoot && (Vi.ShadyCSS === void 0 || Vi.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, es = Symbol(), _a = /* @__PURE__ */ new WeakMap();
let ts = class {
  constructor(t, e, r) {
  ...
  get styleSheet() {
    ...
    if (Qo && t === void 0) {
      ...
      r && (t = _a.get(e)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), r && _a.set(e, t));
    }
    return t;
  }
  toString() {
...
const dn = (n) => new ts(typeof n == "string" ? n : n + "", void 0, es), X = (n, ...t) => {
  ...
  if (Qo) n.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
    ...
    const r = document.createElement("style"), i = Vi.litNonce;
    i !== void 0 && r.setAttribute("nonce", i), r.textContent = e.cssText, n.appendChild(r);
  }
}, ma = Qo ? (n) => n : (n) => n instanceof CSSStyleSheet ? ((t) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Dd, defineProperty: Md, getOwnPropertyDescriptor: Fd, getOwnPropertyNames: Ld, getOwnPropertySymbols: Bd, getPrototypeOf: Vd } = Object, ot = globalThis, ga = ot.trustedTypes, Hd = ga ? ga.emptyScript : "", so = ot.reactiveElementPolyfillSupport, Mr = (n, t) => n, Yi = { toAttribute(n, t) {
  switch (t) {
    case Boolean:
      n = n ? Hd : null;
      break;
  ...
  return e;
} }, rs = (n, t) => !Dd(n, t), ba = { attribute: !0, type: String, converter: Yi, reflect: !1, hasChanged: rs };
...
let Gt = class extends HTMLElement {
  ...
  static createProperty(t, e = ba) {
    if (e.state && (e.attribute = !1), this._$Ei(), this.elementProperties.set(t, e), !e.noAccessor) {
      const r = Symbol(), i = this.getPropertyDescriptor(t, r, e);
      i !== void 0 && Md(this.prototype, t, i);
    }
  }
  static getPropertyDescriptor(t, e, r) {
    const { get: i, set: s } = Fd(this.prototype, t) ?? { get() {
      return this[e];
    }, set(l) {
      this[e] = l;
    } };
  ...
  static getPropertyOptions(t) {
    return this.elementProperties.get(t) ?? ba;
  }
  static _$Ei() {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(Mr("properties"))) {
      const e = this.properties, r = [...Ld(e), ...Bd(e)];
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const i of r) e.unshift(ma(i));
    } else t !== void 0 && e.push(ma(t));
    return e;
  }
  static _$Eu(t, e) {
    const r = e.attribute;
  ...
  _$EC(t, e) {
    ...
    if (i !== void 0 && r.reflect === !0) {
      const l = (((s = r.converter) == null ? void 0 : s.toAttribute) !== void 0 ? r.converter : Yi).toAttribute(e, r.type);
  ...
  _$AK(t, e) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const l = r.getPropertyOptions(i), d = typeof l.converter == "function" ? { fromAttribute: l.converter } : ((s = l.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? l.converter : Yi;
...
Gt.elementStyles = [], Gt.shadowRootOptions = { mode: "open" }, Gt[Mr("elementProperties")] = /* @__PURE__ */ new Map(), Gt[Mr("finalized")] = /* @__PURE__ */ new Map(), so == null || so({ ReactiveElement: Gt }), (ot.reactiveElementVersions ?? (ot.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Fr = globalThis, Zi = Fr.trustedTypes, va = Zi ? Zi.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, Al = "$lit$", tt = `lit$${(Math.random() + "").slice(9)}$`, kl = "?" + tt, Ud = `<${kl}>`, Ot = document, qr = () => Ot.createComment(""), Kr = (n) => n === null || typeof n != "object" && typeof n != "function", Pl = Array.isArray, jd = (n) => Pl(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", ao = `[ 	
\f\r]`, Sr = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ya = /-->/g, xa = />/g, xt = RegExp(`>|${ao}(?:([^\\s"'>=/]+)(${ao}*=${ao}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), wa = /'/g, Ca = /"/g, Sl = /^(?:script|style|textarea|title)$/i, qd = (n) => (t, ...e) => ({ _$litType$: n, strings: t, values: e }), Lr = qd(1), rr = Symbol.for("lit-noChange"), de = Symbol.for("lit-nothing"), Ea = /* @__PURE__ */ new WeakMap(), Et = Ot.createTreeWalker(Ot, 129);
function Il(n, t) {
  if (!Array.isArray(n) || !n.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return va !== void 0 ? va.createHTML(t) : t;
}
const Kd = (n, t) => {
  const e = n.length - 1, r = [];
  let i, s = t === 2 ? "<svg>" : "", l = Sr;
  for (let d = 0; d < e; d++) {
    const f = n[d];
    let _, g, v = -1, z = 0;
    for (; z < f.length && (l.lastIndex = z, g = l.exec(f), g !== null); ) z = l.lastIndex, l === Sr ? g[1] === "!--" ? l = ya : g[1] !== void 0 ? l = xa : g[2] !== void 0 ? (Sl.test(g[2]) && (i = RegExp("</" + g[2], "g")), l = xt) : g[3] !== void 0 && (l = xt) : l === xt ? g[0] === ">" ? (l = i ?? Sr, v = -1) : g[1] === void 0 ? v = -2 : (v = l.lastIndex - g[2].length, _ = g[1], l = g[3] === void 0 ? xt : g[3] === '"' ? Ca : wa) : l === Ca || l === wa ? l = xt : l === ya || l === xa ? l = Sr : (l = xt, i = void 0);
    const B = l === xt && n[d + 1].startsWith("/>") ? " " : "";
    s += l === Sr ? f + Ud : v >= 0 ? (r.push(_), f.slice(0, v) + Al + f.slice(v) + tt + B) : f + tt + (v === -2 ? d : B);
  }
  return [Il(n, s + (n[e] || "<?>") + (t === 2 ? "</svg>" : "")), r];
};
let zo = class Tl {
  constructor({ strings: t, _$litType$: e }, r) {
    ...
    this.parts = [];
    let s = 0, l = 0;
    const d = t.length - 1, f = this.parts, [_, g] = Kd(t, e);
    if (this.el = Tl.createElement(_, r), Et.currentNode = this.el.content, e === 2) {
      const v = this.el.content.firstChild;
      v.replaceWith(...v.childNodes);
    }
    for (; (i = Et.nextNode()) !== null && f.length < d; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const v of i.getAttributeNames()) if (v.endsWith(Al)) {
          const z = g[l++], B = i.getAttribute(v).split(tt), H = /([.?@])?(.*)/.exec(z);
          f.push({ type: 1, index: s, name: H[2], strings: B, ctor: H[1] === "." ? Gd : H[1] === "?" ? Yd : H[1] === "@" ? Zd : un }), i.removeAttribute(v);
        ...
        if (Sl.test(i.tagName)) {
          ...
          if (z > 0) {
            i.textContent = Zi ? Zi.emptyScript : "";
            for (let B = 0; B < z; B++) i.append(v[B], qr()), Et.nextNode(), f.push({ type: 2, index: ++s });
            i.append(v[z], qr());
          }
        }
      } else if (i.nodeType === 8) if (i.data === kl) f.push({ type: 2, index: s });
      else {
        let v = -1;
...
function ir(n, t, e = n, r) {
  ...
  const s = Kr(t) ? void 0 : t._$litDirective$;
...
let Wd = class {
  ...
  u(t) {
    ...
    for (; f !== void 0; ) {
      if (l === f.index) {
        let _;
        f.type === 2 ? _ = new is(s, s.nextSibling, this, t) : f.type === 1 ? _ = new f.ctor(s, f.name, f.strings, this, t) : f.type === 6 && (_ = new Xd(s, this, t)), this._$AV.push(_), f = r[++d];
      }
  ...
  _$AI(t, e = this) {
    t = ir(this, t, e), Kr(t) ? t === de || t == null || t === "" ? (this._$AH !== de && this._$AR(), this._$AH = de) : t !== this._$AH && t !== rr && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : jd(t) ? this.k(t) : this._(t);
  }
  S(t) {
  ...
  _(t) {
    this._$AH !== de && Kr(this._$AH) ? this._$AA.nextSibling.data = t : this.T(Ot.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var s;
    const { values: e, _$litType$: r } = t, i = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = zo.createElement(Il(r.h, r.h[0]), this.options)), r);
    if (((s = this._$AH) == null ? void 0 : s._$AD) === i) this._$AH.p(e);
    else {
      const l = new Wd(i, this), d = l.u(this.options);
      l.p(e), this.T(d), this._$AH = l;
    }
  }
  _$AC(t) {
    let e = Ea.get(t.strings);
    return e === void 0 && Ea.set(t.strings, e = new zo(t)), e;
  }
  k(t) {
    Pl(this._$AH) || (this._$AH = [], this._$AR());
    const e = this._$AH;
    let r, i = 0;
    for (const s of t) i === e.length ? e.push(r = new Ol(this.S(qr()), this.S(qr()), this, this.options)) : r = e[i], r._$AI(s), i++;
  ...
  _$AI(t, e = this, r, i) {
    ...
    let l = !1;
    if (s === void 0) t = ir(this, t, e, 0), l = !Kr(t) || t !== this._$AH && t !== rr, l && (this._$AH = t);
    else {
      const d = t;
      let f, _;
      for (t = s[0], f = 0; f < s.length - 1; f++) _ = ir(this, d[r + f], e, f), _ === rr && (_ = this._$AH[f]), l || (l = !Kr(_) || _ !== this._$AH[f]), _ === de ? t = de : t !== de && (t += (_ ?? "") + s[f + 1]), this._$AH[f] = _;
    }
    l && !i && this.j(t);
  }
  j(t) {
...
const lo = Fr.litHtmlPolyfillSupport;
lo == null || lo(zo, is), (Fr.litHtmlVersions ?? (Fr.litHtmlVersions = [])).push("3.1.2");
const zl = (n, t, e) => {
  const r = (e == null ? void 0 : e.renderBefore) ?? t;
  let i = r._$litPart$;
  if (i === void 0) {
    const s = (e == null ? void 0 : e.renderBefore) ?? null;
    r._$litPart$ = i = new is(t.insertBefore(qr(), s), s, void 0, e ?? {});
  }
  return i._$AI(n), i;
};
/**
...
let Pt = class extends Gt {
  ...
  update(t) {
    const e = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = zl(e, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var t;
...
var wl;
Pt._$litElement$ = !0, Pt.finalized = !0, (wl = globalThis.litElementHydrateSupport) == null || wl.call(globalThis, { LitElement: Pt });
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
const Rl = [], Ro = /* @__PURE__ */ new Set(), ns = /* @__PURE__ */ new Set();
function $l(n) {
  return n && Object.prototype.hasOwnProperty.call(n, "__themes");
}
function Qd(n) {
  return $l(customElements.get(n));
}
function eu(n = []) {
  return [n].flat(1 / 0).filter((t) => t instanceof ts ? !0 : (console.warn("An item in styles is not of type CSSResult. Use `unsafeCSS` or `css`."), !1));
}
function Nl(n, t) {
...
const Xi = "vaadin-themable-mixin-style";
function tu(n, t) {
  const e = document.createElement("style");
  e.id = Xi, e.textContent = Dl(n), t.content.appendChild(e);
}
function ru(n) {
  if (!n.shadowRoot)
    return;
  ...
  if (n instanceof Pt)
    [...n.shadowRoot.querySelectorAll("style")].forEach((e) => e.remove()), El(n.shadowRoot, t.elementStyles);
  else {
    const e = n.shadowRoot.getElementById(Xi), r = t.prototype._template;
    e.textContent = r.content.getElementById(Xi).textContent;
  }
}
function iu(n) {
  Ro.forEach((t) => {
    const e = t.deref();
    e instanceof n ? ru(e) : e || Ro.delete(t);
  });
}
function Ml(n) {
  if (n.prototype instanceof Pt)
    ...
    t.content.getElementById(Xi).textContent = Dl(n.getStylesForThis());
  }
  ns.forEach((t) => {
    const e = customElements.get(t);
    e !== n && e.prototype instanceof n && Ml(e);
  });
}
function nu(n, t) {
  const e = n.__themes;
...
function fe(n, t, e = {}) {
  t = eu(t), window.Vaadin && window.Vaadin.styleModules ? window.Vaadin.styleModules.registerStyles(n, t, e) : Rl.push({
    themeFor: n,
    styles: t,
    include: e.include,
    moduleId: e.moduleId
    ...
    if (Nl(n, r) && Qd(r)) {
      ...
      nu(i, t) ? console.warn(`Registering styles that already exist for ${r}`) : (!window.Vaadin || !window.Vaadin.suppressPostFinalizeStylesWarning) && console.warn(
        `The custom element definition for "${r}" was finalized before a style module was registered. Ideally, import component specific style modules before importing the corresponding custom element. This warning can be suppressed by setting "window.Vaadin.suppressPostFinalizeStylesWarning = true".`
      ), Ml(i), iu(i);
    }
  });
}
function $o() {
  return window.Vaadin && window.Vaadin.styleModules ? window.Vaadin.styleModules.getAllThemes() : Rl;
}
function ou(n = "") {
  let t = 0;
...
function Fl(n) {
  ...
  return n.include && [].concat(n.include).forEach((e) => {
    ...
    r ? t.push(...Fl(r), ...r.styles) : console.warn(`Included moduleId ${e} not found in style registry`);
  }, n.styles), t;
}
function su(n) {
  const t = `${n}-default-theme`, e = $o().filter((r) => r.moduleId !== t && Nl(r.themeFor, n)).map((r) => ({
    ...r,
    // Prepend styles from included themes
    styles: [...Fl(r), ...r.styles],
    // Map moduleId to includePriority
    includePriority: ou(r.moduleId)
  })).sort((r, i) => i.includePriority - r.includePriority);
  return e.length > 0 ? e : $o().filter((r) => r.moduleId === t);
}
const ti = (n) => class extends Jd(n) {
  constructor() {
  ...
  static finalize() {
    ...
    !e || $l(this) || tu(this.getStylesForThis(), e);
  }
  /**
...
`;
fe("", _u, { moduleId: "lumo-typography" });
cr("typography-props", pu);
fe(
  "vaadin-grid",
  X`
    :host {
...
function Br(n, t) {
  ...
  if (Ri === void 0) {
    ...
    try {
      ...
      e.pathname = "c%20d", Ri = e.href === "http://a/c%20d";
    } catch {
    }
  }
  if (t || (t = document.baseURI || window.location.href), Ri)
    try {
...
function os(n, t) {
  return n.replace(mu, function(e, r, i, s) {
    return r + "'" + Br(i.replace(/["']/g, ""), t) + "'" + s;
  });
}
function ss(n) {
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const bu = !window.ShadyDOM || !window.ShadyDOM.inUse;
!window.ShadyCSS || window.ShadyCSS.nativeCss;
const vu = bu && "adoptedStyleSheets" in Document.prototype && "replaceSync" in CSSStyleSheet.prototype && // Since spec may change, feature detect exact API we need
(() => {
  try {
...
let yu = window.Polymer && window.Polymer.rootPath || ss(document.baseURI || window.location.href), Ji = window.Polymer && window.Polymer.sanitizeDOMValue || void 0;
window.Polymer && window.Polymer.setPassiveTouchGestures;
let No = window.Polymer && window.Polymer.strictTemplatePolicy || !1, xu = window.Polymer && window.Polymer.allowTemplateFromDomModule || !1, wu = window.Polymer && window.Polymer.legacyOptimizations || !1, Cu = window.Polymer && window.Polymer.legacyWarnings || !1, Eu = window.Polymer && window.Polymer.syncInitialRender || !1, Do = window.Polymer && window.Polymer.legacyUndefined || !1, Au = window.Polymer && window.Polymer.orderedComputed || !1, Aa = window.Polymer && window.Polymer.removeNestedTemplates || !1, ku = window.Polymer && window.Polymer.fastDomIf || !1;
window.Polymer && window.Polymer.suppressTemplateNotifications;
window.Polymer && window.Polymer.legacyNoObservedAttributes;
let Pu = window.Polymer && window.Polymer.useAdoptedStyleSheetsWithBuiltCSS || !1;
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
let as = {}, Ll = {};
function ka(n, t) {
  as[n] = Ll[n.toLowerCase()] = t;
}
function Pa(n) {
  return as[n] || Ll[n.toLowerCase()];
}
function Iu(n) {
  n.querySelector("style") && console.warn("dom-module %s has style outside template", n.id);
}
class Wr extends HTMLElement {
  ...
  get assetpath() {
    if (!this.__assetpath) {
      const t = window.HTMLImports && HTMLImports.importForElement ? HTMLImports.importForElement(this) || document : this.ownerDocument, e = Br(
  ...
  register(t) {
    if (t = t || this.id, t) {
      if (No && Pa(t) !== void 0)
        throw ka(t, null), new Error(`strictTemplatePolicy: dom-module ${t} re-registered`);
      this.id = t, ka(t, this), Iu(this);
    }
  }
}
Wr.prototype.modules = as;
customElements.define("dom-module", Wr);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const Tu = "link[rel=import][type~=css]", Ou = "include", Sa = "shady-unscoped";
function Bl(n) {
  return (
    /** @type {?DomModule} */
    Wr.import(n)
...
function Ru(n) {
  const t = Bl(n);
  if (!t)
    return console.warn("Could not find style data in module named", n), [];
  if (t._styles === void 0) {
    const e = [];
    e.push(...Hl(t));
    const r = (
...
function Vl(n, t) {
  if (!n._styles) {
    ...
    for (let i = 0; i < r.length; i++) {
      let s = r[i], l = s.getAttribute(Ou);
      l && e.push(...zu(l).filter(function(d, f, _) {
        return _.indexOf(d) === f;
      })), t && (s.textContent = os(
        s.textContent,
        /** @type {string} */
        t
...
function Hl(n) {
  const t = [], e = n.querySelectorAll(Tu);
  for (let r = 0; r < e.length; r++) {
    let i = e[r];
    if (i.import) {
      const s = i.import, l = i.hasAttribute(Sa);
      if (l && !s._unscopedStyle) {
        const d = Ia(s);
        d.setAttribute(Sa, ""), s._unscopedStyle = d;
      } else s._style || (s._style = Ia(s));
...
function Ul(n) {
  return Array.isArray(n) ? $r(n).split(".") : n.toString().split(".");
}
function Pe(n, t, e) {
  let r = n, i = Ul(t);
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const tn = {}, Du = /-[a-z]/g, Mu = /([A-Z])/g;
function jl(n) {
  return tn[n] || (tn[n] = n.indexOf("-") < 0 ? n : n.replace(
    Du,
    (t) => t[1].toUpperCase()
  ));
}
function hn(n) {
  return tn[n] || (tn[n] = n.replace(Mu, "-$1").toLowerCase());
}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
let Fu = 0, ql = 0, Xt = [], Lu = 0, Fo = !1, Kl = document.createTextNode("");
new window.MutationObserver(Bu).observe(Kl, { characterData: !0 });
function Bu() {
  Fo = !1;
  const n = Xt.length;
  for (let t = 0; t < n; t++) {
...
const Vu = {
   ...
   */
  run(n) {
    return Fo || (Fo = !0, Kl.textContent = Lu++), Xt.push(n), Fu++;
  },
  /**
  ...
  (n) => {
    class t extends n {
      ...
      _invalidateProperties() {
        !this.__dataInvalid && this.__dataReady && (this.__dataInvalid = !0, Hu.run(() => {
...
const Uu = window.trustedTypes ? (n) => trustedTypes.isHTML(n) || trustedTypes.isScript(n) || trustedTypes.isScriptURL(n) : () => !1;
function ju(n, t) {
  if (!Gl[t]) {
    let e = n[t];
...
const qu = me((n) => {
  ...
  class e extends t {
    ...
    static createPropertiesForAttributes() {
      ...
      for (let s = 0; s < i.length; s++)
        this.prototype._createPropertyAccessor(jl(i[s]));
    }
    /**
     * Returns an attribute name that corresponds to the given property.
      ...
      switch (s) {
        ...
        case Array:
          try {
            ...
            l = null, console.warn(`Polymer::Attributes: couldn't decode Array as JSON: ${i}`);
          }
          break;
        case Date:
    ...
    _definePropertyAccessor(i, s) {
      ju(this, i), super._definePropertyAccessor(i, s);
    }
    /**
...
function Wu() {
  if (!Oa) {
    ...
    n.placeholder = "a", za = n.placeholder === n.textContent;
  }
  return za;
}
function Gu(n) {
  Wu() && n.localName === "textarea" && n.placeholder && n.placeholder === n.textContent && (n.textContent = null);
}
const Yu = (() => {
...
function Zu(n) {
  ...
  if (t && Ku[t]) {
    ...
    for (e.removeAttribute("is"), n = e.ownerDocument.createElement(t), e.parentNode.replaceChild(n, e), n.appendChild(e); e.attributes.length; ) {
      ...
      Yu(n, e, r), e.removeAttribute(r);
    }
  }
  return n;
}
function Yl(n, t) {
  let e = t.parentInfo && Yl(n, t.parentInfo);
  if (e) {
...
function eh(n, t, e) {
  return n = n._methodHost || n, function(i) {
    n[e] ? n[e](i, i.detail) : console.warn("listener method `" + e + "` not defined");
  };
}
const th = me(
  /**
  ...
  (n) => {
    class t extends n {
      ...
      static _parseTemplateNode(r, i, s) {
        ...
        return d.localName == "template" && !d.hasAttribute("preserve-content") ? l = this._parseTemplateNestedTemplate(d, i, s) || l : d.localName === "slot" && (i.hasInsertionPoint = !0), Gu(d), d.firstChild && this._parseTemplateChildNodes(d, i, s), d.hasAttributes && d.hasAttributes() && (l = this._parseTemplateNodeAttributes(d, i, s) || l), l || s.noted;
      }
      /**
      ...
      static _parseTemplateChildNodes(r, i, s) {
        if (!(r.localName === "script" || r.localName === "style"))
          for (let l = r.firstChild, d = 0, f; l; l = f) {
            if (l.localName == "template" && (l = Zu(l)), f = l.nextSibling, l.nodeType === Node.TEXT_NODE) {
              let g = f;
            ...
            this._parseTemplateNode(l, i, _) && (_.infoIndex = i.nodeInfoList.push(_) - 1), l.parentNode && d++;
          }
      }
      /**
      ...
      static _parseTemplateNodeAttributes(r, i, s) {
        ...
        for (let f = d.length - 1, _; _ = d[f]; f--)
          l = this._parseTemplateNodeAttribute(r, i, s, _.name, _.value) || l;
        return l;
      }
      /**
      ...
      _stampTemplate(r, i) {
        ...
        d.$ = {};
        for (let _ = 0, g = s.length, v; _ < g && (v = s[_]); _++) {
          let z = f[_] = Yl(d, v);
          Xu(this, d.$, z, v), Qu(this, z, v, i), Ju(this, z, v);
        }
...
function Nr(n, t, e, r, i, s) {
  if (t) {
    let l = !1;
    const d = Gr++;
    for (let f in e) {
      let _ = i ? Nt(f) : f, g = t[_];
      if (g)
...
function ih(n, t, e, r, i, s, l, d) {
  let f = !1, _ = l ? Nt(r) : r, g = t[_];
  if (g)
    for (let v = 0, z = g.length, B; v < z && (B = g[v]); v++)
...
function ls(n, t) {
  if (t) {
    ...
    return e == n || !!(t.structured && Nu(e, n)) || !!(t.wildcard && Qi(e, n));
  } else
    return !0;
}
function Ra(n, t, e, r, i) {
  let s = typeof i.method == "string" ? n[i.method] : i.method, l = i.property;
  s ? s.call(n, n.__data[l], r[l]) : i.dynamicFn || console.warn("observer method `" + i.method + "` not defined");
}
function nh(n, t, e, r, i) {
  let s = n[Q.NOTIFY], l, d = Gr++;
  for (let _ in t)
    t[_] && (s && ih(n, s, d, _, e, r, i) || i && oh(n, _, e)) && (l = !0);
  let f;
...
function sh(n, t, e, r, i, s) {
  let d = (s ? Nt(t) : t) != t ? t : null, f = d ? Pe(n, d) : n.__data[t];
  d && f === void 0 && (f = e[t]), Xl(n, i.eventName, f, d);
}
function ah(n, t, e, r, i) {
  ...
  d ? (r = en(e, r, d), s = l && l.value) : s = n.currentTarget[e], s = i ? !s : s, (!t[Q.READ_ONLY] || !t[Q.READ_ONLY][r]) && t._setPendingPropertyOrPath(r, s, !0, !!d) && (!l || !l.queueProperty) && t._invalidateProperties();
}
function lh(n, t, e, r, i) {
  let s = n.__data[t];
  Ji && (s = Ji(
    s,
    i.attrName,
...
function ch(n, t, e, r) {
  ...
  if (i)
    if (Au) {
      ...
      let d;
      for (; d = l.shift(); )
        Jl(n, "", t, e, d) && $a(d.methodInfo, i, l, s, r);
      Object.assign(
        /** @type {!Object} */
        e,
        n.__dataOld
...
const dh = (n, t, e) => {
  ...
  if (l)
    for (let d = 0; d < l.length; d++) {
      const f = l[d];
      f.info.lastRun !== Gr && (!i || ls(n, f.trigger)) && (f.info.lastRun = Gr, dh(f.info, e, r));
    }
};
function uh(n) {
  ...
  if (!t) {
    t = /* @__PURE__ */ new Map();
    const e = n[Q.COMPUTE];
    let { counts: r, ready: i, total: s } = hh(n), l;
    for (; l = i.shift(); ) {
      t.set(l, t.size);
      const d = e[l];
      d && d.forEach((f) => {
        const _ = f.info.methodInfo;
        --s, --r[_] === 0 && i.push(_);
      });
    }
    s !== 0 && console.warn(`Computed graph for ${/** @type {HTMLElement} */
    n.localName} incomplete; circular?`), n.constructor.__orderedComputedDeps = t;
  }
  return t;
}
function hh(n) {
  const t = n[Zl], e = {}, r = n[Q.COMPUTE], i = [];
  let s = 0;
  for (let l in t) {
    const d = t[l];
...
function fh(n, t, e) {
  ...
  if (r) {
    ...
    for (let s in r) {
      let l = r[s];
      Qi(s, t) ? (i = en(s, l, t), n._setPendingPropertyOrPath(i, e, !0, !0)) : Qi(l, t) && (i = en(l, s, t), n._setPendingPropertyOrPath(i, e, !0, !0));
    }
  }
}
function ho(n, t, e, r, i, s, l) {
  ...
  if (e.bindings.push(d), bh(d)) {
    let { event: _, negate: g } = d.parts[0];
    d.listenerEvent = _ || hn(i) + "-changed", d.listenerNegate = g;
  }
  let f = t.nodeInfoList.length;
  for (let _ = 0; _ < d.parts.length; _++) {
    let g = d.parts[_];
    g.compoundIndex = _, ph(n, t, d, g, f);
  }
}
function ph(n, t, e, r, i) {
  if (!r.literal)
    if (e.kind === "attribute" && e.target[0] === "-")
      ...
      for (let d = 0; d < s.length; d++) {
        let f = s[d];
        typeof f == "string" && (f = ec(f), f.wildcard = !0), n._addTemplatePropertyEffect(t, f.rootProperty, {
          fn: _h,
          info: l,
          trigger: f
        });
...
function _h(n, t, e, r, i, s, l) {
  let d = l[i.index], f = i.binding, _ = i.part;
  if (s && _.source && t.length > _.source.length && f.kind == "property" && !f.isCompound && d.__isPropertyEffectsClient && d.__dataHasAccessor && d.__dataHasAccessor[f.target]) {
    let g = e[t];
    t = en(_.source, f.target, t), d._setPendingPropertyOrPath(t, g, !1, !0) && n._enqueueClient(d);
  } else {
    let g = i.evaluator._evaluateBinding(n, _, t, e, r, s);
    g !== Yr && mh(n, d, f, _, g);
  }
}
function mh(n, t, e, r, i) {
  if (i = gh(t, i, e, r), Ji && (i = Ji(i, e.target, e.kind, t)), e.kind == "attribute")
...
function xh(n, t, e) {
  if (e.listenerEvent) {
    ...
    n.addEventListener(e.listenerEvent, function(i) {
      ah(i, t, e.target, r.source, r.negate);
    });
  }
}
function Na(n, t, e, r, i, s) {
...
function Lo(n, t, e, r, i) {
  ...
  if (l) {
    ...
    return d === Yr ? Yr : l.apply(s, d);
  } else i.dynamicFn || console.warn("method `" + i.methodName + "` not defined");
}
const wh = [], Ql = "(?:[a-zA-Z_$][\\w.:$\\-*]*)", Ch = "(?:[-+]?[0-9]*\\.?[0-9]+(?:[eE][-+]?[0-9]+)?)", Eh = "(?:'(?:[^'\\\\]|\\\\.)*')", Ah = '(?:"(?:[^"\\\\]|\\\\.)*")', kh = "(?:" + Eh + "|" + Ah + ")", Da = "(?:(" + Ql + "|" + Ch + "|" + kh + ")\\s*)", Ph = "(?:" + Da + "(?:,\\s*" + Da + ")*)", Sh = "(?:\\(\\s*(?:" + Ph + "?)\\)\\s*)", Ih = "(" + Ql + "\\s*" + Sh + "?)", Th = "(\\[\\[|{{)\\s*", Oh = "(?:]]|}})", zh = "(?:(!)\\s*)?", Rh = Th + zh + Ih + Oh, Ma = new RegExp(Rh, "g");
function Fa(n) {
  let t = "";
  for (let e = 0; e < n.length; e++) {
    let r = n[e].literal;
...
function fo(n) {
  let t = n.match(/([^\s]+?)\(([\s\S]*)\)/);
  if (t) {
    let r = { methodName: t[1], static: !0, args: wh };
    if (t[2].trim()) {
...
const Dh = me((n) => {
  ...
  class e extends t {
    ...
    _setPendingPropertyOrPath(i, s, l, d) {
      if (d || Nt(Array.isArray(i) ? i[0] : i) !== i) {
        if (!d) {
          let f = Pe(this, i);
          if (i = /** @type {string} */
          Ta(this, i, s), !i || !super._shouldPropertyChange(i, s, f))
            return !1;
        }
    ...
    _propertiesChanged(i, s, l) {
      ...
      let f;
      ch(this, s, l, d), f = this.__dataToNotify, this.__dataToNotify = null, this._propagatePropertyChanges(s, l, d), this._flushClients(), Nr(this, this[Q.REFLECT], s, l, d), Nr(this, this[Q.OBSERVE], s, l, d), f && nh(this, f, s, l, d), this.__dataCounter == 1 && (this.__dataTemp = {});
    }
    /**
    ...
    _propagatePropertyChanges(i, s, l) {
      this[Q.PROPAGATE] && Nr(this, this[Q.PROPAGATE], i, s, l), this.__templateInfo && this._runEffectsForTemplate(this.__templateInfo, i, s, l);
    }
    _runEffectsForTemplate(i, s, l, d) {
      const f = (_, g) => {
        ...
        for (let v = i.firstChild; v; v = v.nextSibling)
          this._runEffectsForTemplate(v, _, l, g);
      };
     ...
     */
    linkPaths(i, s) {
      i = $r(i), s = $r(s), this.__dataLinkedPaths = this.__dataLinkedPaths || {}, this.__dataLinkedPaths[i] = s;
    }
    /**
     ...
     */
    unlinkPaths(i) {
      i = $r(i), this.__dataLinkedPaths && delete this.__dataLinkedPaths[i];
    }
    /**
     ...
     */
    set(i, s, l) {
      l ? Ta(l, i, s) : (!this[Q.READ_ONLY] || !this[Q.READ_ONLY][
        /** @type {string} */
        i
    ...
    push(i, ...s) {
      let l = { path: "" }, d = (
        /** @type {Array}*/
        Pe(this, i, l)
      ), f = d.length, _ = d.push(...s);
      return s.length && Ir(this, d, l.path, f, s.length, []), _;
    }
    /**
    ...
    pop(i) {
      ...
      return d && Ir(this, l, s.path, l.length, 0, [f]), f;
    }
    /**
    ...
    splice(i, s, l, ...d) {
      ...
      s < 0 ? s = _.length - Math.floor(-s) : s && (s = Math.floor(s));
      let g;
      return arguments.length === 2 ? g = _.splice(s) : g = _.splice(s, l, ...d), (d.length || g.length) && Ir(this, _, f.path, s, d.length, g), g;
    }
    /**
    ...
    shift(i) {
      ...
      return d && Ir(this, l, s.path, 0, 0, [f]), f;
    }
    /**
    ...
    unshift(i, ...s) {
      ...
      return s.length && Ir(this, d, l.path, 0, s.length, []), f;
    }
    /**
    ...
    notifyPath(i, s) {
      ...
      if (arguments.length == 1) {
        let d = { path: "" };
        s = Pe(this, i, d), l = d.path;
      } else Array.isArray(i) ? l = $r(i) : l = /** @type{string} */
      i;
    ...
    _createReadOnlyProperty(i, s) {
      this._addPropertyEffect(i, Q.READ_ONLY), s && (this["_set" + Nh(i)] = /** @this {PropertyEffects} */
      function(l) {
    ...
    _createReflectedProperty(i) {
      ...
      s[0] === "-" ? console.warn("Property " + i + " cannot be reflected to attribute " + s + ' because "-" is not a valid starting attribute name. Use a lowercase first letter for the property instead.') : this._addPropertyEffect(i, Q.REFLECT, {
        fn: lh,
        info: {
          attrName: s
        }
    ...
    _createComputedProperty(i, s, l) {
      ...
      const f = Na(this, d, Q.COMPUTE, Jl, i, l);
      uo(this, Zl)[i] = f;
    }
    /**
    ...
    _marshalArgs(i, s, l) {
      ...
      for (let _ = 0, g = i.length; _ < g; _++) {
        let { name: v, structured: z, wildcard: B, value: H, literal: ee } = i[_];
        if (!ee)
          if (B) {
            const se = Qi(v, s), ae = La(d, l, se ? s : v);
            H = {
              path: se ? s : v,
              value: ae,
              base: se ? Pe(d, v) : ae
    ...
    _bindTemplate(i, s) {
      ...
      if (s)
        ...
        Object.create(l), l.wasPreBound = d, !this.__templateInfo)
          ...
          const f = i._parentTemplateInfo || this.__templateInfo, _ = f.lastChild;
          l.parent = f, f.lastChild = l, l.previousSibling = _, _ ? _.nextSibling = l : f.firstChild = l;
        }
      else
    ...
    _stampTemplate(i, s) {
      ...
      this._bindTemplate(i, !0), Tr.push(this);
      let l = super._stampTemplate(i, s);
      if (Tr.pop(), s.nodeList = l.nodeList, !s.wasPreBound) {
        let d = s.childNodes = [];
        for (let f = l.firstChild; f; f = f.nextSibling)
          d.push(f);
      }
      return l.templateInfo = s, vh(this, s), this.__dataClientsReady && (this._runEffectsForTemplate(s, this.__data, null, !1), this._flushClients()), l;
    }
    /**
    ...
    static _parseTemplateNode(i, s, l) {
      ...
      if (i.nodeType === Node.TEXT_NODE) {
        ...
        f && (i.textContent = Fa(f) || " ", ho(this, s, l, "text", "textContent", f), d = !0);
      }
      return d;
    }
    /**
    ...
    static _parseTemplateNodeAttribute(i, s, l, d, f) {
      let _ = this._parseBindings(f, s);
      if (_) {
        let g = d, v = "property";
        rh.test(d) ? v = "attribute" : d[d.length - 1] == "$" && (d = d.slice(0, -1), v = "attribute");
        let z = Fa(_);
        return z && v == "attribute" && (d == "class" && i.hasAttribute("class") && (z += " " + i.getAttribute(d)), i.setAttribute(d, z)), v == "attribute" && g == "disable-upgrade$" && i.setAttribute(d, ""), i.localName === "input" && g === "value" && i.setAttribute(g, ""), i.removeAttribute(g), v === "property" && (d = jl(d)), ho(this, s, l, v, d, _, z), !0;
      } else
    ...
    static _parseTemplateNestedTemplate(i, s, l) {
      ...
      const f = i.parentNode, _ = l.templateInfo, g = f.localName === "dom-if", v = f.localName === "dom-repeat";
      Aa && (g || v) && (f.removeChild(i), l = l.parentInfo, l.templateInfo = _, l.noted = !0, d = !1);
      let z = _.hostProps;
      if (ku && g)
        z && (s.hostProps = Object.assign(s.hostProps || {}, z), Aa || (l.parentInfo.noted = !0));
      else {
        let B = "{";
        for (let H in z) {
    ...
    static _parseBindings(i, s) {
      let l = [], d = 0, f;
      for (; (f = Ma.exec(i)) !== null; ) {
        f.index > d && l.push({ literal: i.slice(d, f.index) });
        let _ = f[1][0], g = !!f[2], v = f[3].trim(), z = !1, B = "", H = -1;
        _ == "{" && (H = v.indexOf("::")) > 0 && (B = v.substring(H + 2), v = v.substring(0, H), z = !0);
        let ee = fo(v), se = [];
        if (ee) {
     ...
     * @nocollapse
     */
    static _evaluateBinding(i, s, l, d, f, _) {
      let g;
      return s.signature ? g = Lo(i, l, d, f, s.signature) : l != s.source ? g = Pe(i, s.source) : _ && Mo(l) ? g = Pe(i, l) : g = i.__data[l], s.negate && (g = !g), g;
    }
  }
  return e;
}), Tr = [];
 ...
 * rights grant found at http://polymer.github.io/PATENTS.txt
 */
const Lh = "3.5.1", Ba = window.ShadyCSS && window.ShadyCSS.cssBuild, Bh = me((n) => {
  const t = Fh(Dh(n));
  function e(f) {
    if (!f.hasOwnProperty(
  ...
  function i(f, _, g, v) {
    g.computed && (g.readOnly = !0), g.computed && (f._hasReadOnlyEffect(_) ? console.warn(`Cannot redefine computed property '${_}'.`) : f._createComputedProperty(_, g.computed, v)), g.readOnly && !f._hasReadOnlyEffect(_) ? f._createReadOnlyProperty(_, !g.computed) : g.readOnly === !1 && f._hasReadOnlyEffect(_) && console.warn(`Cannot make readOnly property '${_}' non-readOnly.`), g.reflectToAttribute && !f._hasReflectEffect(_) ? f._createReflectedProperty(_) : g.reflectToAttribute === !1 && f._hasReflectEffect(_) && console.warn(`Cannot make reflected property '${_}' non-reflected.`), g.notify && !f._hasNotifyEffect(_) ? f._createNotifyingProperty(_) : g.notify === !1 && f._hasNotifyEffect(_) && console.warn(`Cannot make notify property '${_}' non-notify.`), g.observer && f._createPropertyObserver(_, g.observer, v[g.observer]), f._addPropertyToAttributeMap(_);
  }
  function s(f, _, g, v) {
    if (!Ba) {
      const z = _.content.querySelectorAll("style"), B = Vl(_), H = $u(g), ee = _.content.firstElementChild;
      for (let ae = 0; ae < H.length; ae++) {
        let re = H[ae];
        re.textContent = f._processStyleText(re.textContent, v), _.content.insertBefore(re, ee);
      }
      let se = 0;
    ...
    if (window.ShadyCSS && window.ShadyCSS.prepareTemplate(_, g), Pu && Ba && vu) {
      const z = _.content.querySelectorAll("style");
      if (z) {
        let B = "";
  ...
  function l(f) {
    let _ = null;
    if (f && (!No || xu) && (_ = /** @type {?HTMLTemplateElement} */
    Wr.import(f, "template"), No && !_))
  ...
  class d extends t {
    ...
    static _finalizeClass() {
      ...
      const _ = r(this);
      _ && this.createObservers(_, this._properties), this._prepareTemplate();
    }
    /** @nocollapse */
    static _prepareTemplate() {
      ...
      _ && (typeof _ == "string" ? (console.error("template getter must return HTMLTemplateElement"), _ = null) : wu || (_ = _.cloneNode(!0))), this.prototype._template = _;
    }
    /**
     ...
     * @nocollapse
     */
    static createObservers(_, g) {
      const v = this.prototype;
      for (let z = 0; z < _.length; z++)
        v._createMethodObserver(_[z], g);
    }
    /**
    ...
    static get template() {
      if (!this.hasOwnProperty(JSCompiler_renameProperty("_template", this))) {
        let _ = this.prototype.hasOwnProperty(
          JSCompiler_renameProperty("_template", this.prototype)
        ) ? this.prototype._template : void 0;
        typeof _ == "function" && (_ = _()), this._template = // If user has put template on prototype (e.g. in legacy via registered
    ...
    static get importPath() {
      if (!this.hasOwnProperty(JSCompiler_renameProperty("_importPath", this))) {
        const _ = this.importMeta;
        if (_)
          this._importPath = ss(_.url);
        else {
          const g = Wr.import(
            /** @type {PolymerElementConstructor} */
            this.is
    ...
    _initializeProperties() {
      this.constructor.finalize(), this.constructor._finalizeTemplate(
        /** @type {!HTMLElement} */
        this.localName
      ), super._initializeProperties(), this.rootPath = yu, this.importPath = this.constructor.importPath;
      let _ = e(this.constructor);
      if (_)
        for (let g in _) {
          let v = _[g];
    ...
    * @nocollapse
    */
    static _finalizeTemplate(_) {
      const g = this.prototype._template;
      if (g && !g.__polymerFinalized) {
        g.__polymerFinalized = !0;
        const v = this.importPath, z = v ? Br(v) : "";
        s(this, g, _, z), this.prototype._bindTemplate(g);
      }
    }
    /**
    ...
    _attachDom(_) {
      const g = St(this);
      if (g.attachShadow)
        return _ ? (g.shadowRoot || (g.attachShadow({ mode: "open", shadyUpgradeFragment: _ }), g.shadowRoot.appendChild(_), this.constructor._styleSheet && (g.shadowRoot.adoptedStyleSheets = [this.constructor._styleSheet])), Eu && window.ShadyDOM && window.ShadyDOM.flushInitial(g.shadowRoot), g.shadowRoot) : null;
     ...
     */
    resolveUrl(_, g) {
      return !g && this.importPath && (g = Br(this.importPath)), Br(_, g);
    }
    /**
     ...
     * @nocollapse
     */
    static _parseTemplateContent(_, g, v) {
     ...
     * @nocollapse
     */
    static _addTemplatePropertyEffect(_, g, v) {
      return Cu && !(g in this._properties) && // Methods used in templates with no dependencies (or only literal
      ...
      // (`nestedTemplate`)
      !v.info.part.hostProp && !_.nestedTemplate && console.warn(`Property '${g}' used in template but not declared in 'properties'; attribute will not be observed.`), t._addTemplatePropertyEffect.call(
        this,
        _,
        g,
        v
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const Va = window.trustedTypes && trustedTypes.createPolicy("polymer-html-literal", { createHTML: (n) => n });
class rc {
  /**
...
const dr = function(t, ...e) {
  ...
  return Va && (i = Va.createHTML(i)), r.innerHTML = i, r;
}, nc = (n, t) => {
...
const Ke = {
   ...
   */
  run(n) {
    Bo || (Bo = !0, queueMicrotask(() => Hh())), Jt.push(n);
    const t = Ha;
    return Ha += 1, t;
  },
  /**
...
class ie {
  ...
  setConfig(t, e) {
    this._asyncModule = t, this._callback = e, this._timer = this._asyncModule.run(() => {
      this._timer = null, Zr.delete(this), this._callback();
    });
  }
  /**
   ...
   */
  cancel() {
    this.isActive() && (this._cancelAsync(), Zr.delete(this));
  }
  /**
...
const qh = new MutationObserver(jh);
qh.observe(document.documentElement, { attributes: !0, attributeFilter: ["dir"] });
...
function cs(n) {
  ...
  n.querySelector("template") && console.warn(
    `WARNING: <template> inside <${n.localName}> is no longer supported. Import @vaadin/polymer-legacy-adapter/template-renderer.js to enable compatibility.`
  );
}
/**
 * @license
...
function lc(n, t) {
  return t ? t.closest(n) || lc(n, t.getRootNode().host) : null;
}
function ds(n) {
...
function Ct(n, t, e, r, i) {
  _n(n, t, e), i && lt(n, !1, i), lt(n, e, r || `${t}-cell`);
}
class Qt {
  constructor(t, e) {
    this.__host = t, this.__callback = e, this.__currentSlots = [], this.__onMutation = this.__onMutation.bind(this), this.__observer = new MutationObserver(this.__onMutation), this.__observer.observe(t, {
      childList: !0
    }), this.__initialCallDebouncer = ie.debounce(this.__initialCallDebouncer, Ne, () => this.__onMutation());
  }
  disconnect() {
...
}), Jh = /\/\*[\*!]\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i, Hi = window.Vaadin && window.Vaadin.Flow && window.Vaadin.Flow.clients;
function Qh() {
  function n() {
    return !0;
  }
...
function nf() {
  return !!(Hi && Object.keys(Hi).map((t) => Hi[t]).filter((t) => t.productionMode).length > 0);
}
function cc(n, t) {
  if (typeof n != "function")
    return;
  const e = Jh.exec(n.toString());
  if (e)
    try {
      n = new Function(e[1]);
    } catch (r) {
      console.log("vaadin-development-mode-detector: uncommentAndRun() failed", r);
    }
  return n(t);
}
window.Vaadin = window.Vaadin || {};
const ja = function(n, t) {
  if (window.Vaadin.developmentMode)
    return cc(n, t);
};
window.Vaadin.developmentMode === void 0 && (window.Vaadin.developmentMode = ef());
function of() {
}
const sf = function() {
...
let po;
const qa = /* @__PURE__ */ new Set(), dc = (n) => class extends ri(n) {
  /** @protected */
  static finalize() {
    super.finalize();
    const { is: e } = this;
    e && !qa.has(e) && (window.Vaadin.registrations.push(this), qa.add(e), window.Vaadin.developmentModeCallback && (po = ie.debounce(po, sc, () => {
...
function lf(n, t) {
  ...
  for (; n.length > 0 && t.length > 0; )
    af(n[0], t[0]) ? e.push(t.shift()) : e.push(n.shift());
  return e.concat(n, t);
}
function jo(n) {
  const t = n.length;
...
function rn(n) {
  return n.offsetParent === null && n.clientWidth === 0 && n.clientHeight === 0 ? !0 : uc(n);
}
function cf(n) {
...
function fc(n, t) {
  if (n.nodeType !== Node.ELEMENT_NODE || uc(n))
    return !1;
  const e = (
    /** @type {HTMLElement} */
    n
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
const mn = (n) => n.test(navigator.userAgent), qo = (n) => n.test(navigator.platform), hf = (n) => n.test(navigator.vendor), Ka = mn(/Android/u), ff = mn(/Chrome/u) && hf(/Google Inc/u), pf = mn(/Firefox/u), _f = qo(/^iPad/u) || qo(/^Mac/u) && navigator.maxTouchPoints > 1, mf = qo(/^iPhone/u), Ko = mf || _f, mc = mn(/^((?!chrome|android).)*safari/iu), Xr = (() => {
  try {
...
class ps extends EventTarget {
  ...
  static generateId(t, e) {
    return `${e || "default"}-${t.localName}-${gc()}`;
  }
  constructor(t, e, r, i = {}) {
    super();
  ...
  observeSlot() {
    ...
    this.__slotObserver = new gf(r, ({ addedNodes: i, removedNodes: s }) => {
      const l = this.multiple ? this.nodes : [this.node], d = i.filter((f) => !Wh(f) && !l.includes(f));
 ...
 * subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
 */
const Wa = navigator.userAgent.match(/iP(?:hone|ad;(?: U;)? CPU) OS (\d+)/u), vf = Wa && Wa[1] >= 8, Ga = 3, yf = {
  /**
  ...
  _scrollHandler() {
    ...
    if (this._scrollPosition = n, this._firstVisibleIndexVal = null, this._lastVisibleIndexVal = null, Math.abs(t) > this._physicalSize && this._physicalSize > 0) {
      ...
      e ? (this._physicalTop = r.physicalTop, this._virtualStart += r.indexes.length, this._physicalStart += r.indexes.length) : (this._virtualStart -= r.indexes.length, this._physicalStart -= r.indexes.length), this._update(r.indexes, e ? null : r.indexes), this._debounce("_increasePoolIfNeeded", this._increasePoolIfNeeded.bind(this, 0), Ne);
    }
  },
  /**
  ...
  _getReusables(n) {
    ...
    let _ = this._physicalTop + this._scrollOffset;
    const g = this._physicalBottom + this._scrollOffset, v = this._scrollPosition, z = this._scrollBottom;
    for (n ? (t = this._physicalStart, e = v - _) : (t = this._physicalEnd, e = g - z); r = this._getPhysicalSizeIncrement(t), e -= r, !(i.length >= f || e <= s); )
      if (n) {
        if (d + i.length + 1 >= this._virtualCount || _ + r >= v - this._scrollOffset)
          break;
        i.push(t), _ += r, t = (t + 1) % f;
      } else {
        if (l - i.length <= 0 || _ + this._physicalSize - r <= z)
          break;
        i.push(t), _ -= r, t = t === 0 ? f - 1 : t - 1;
      }
    return { indexes: i, physicalTop: _ - this._scrollOffset };
  },
  /**
  ...
  _increasePoolIfNeeded(n) {
    ...
    if (!(e < 0)) {
      ...
      this._virtualEnd >= this._virtualCount - 1 || r === 0 || (this._isClientFull() ? this._physicalSize < this._optPhysicalSize && this._debounce(
        ...
        sc
      ) : this._debounce("_increasePoolIfNeeded", this._increasePoolIfNeeded.bind(this, r), Ne));
    }
  },
  /**
  ...
  _render() {
    if (!(!this.isAttached || !this._isVisible))
      ...
      } else this._virtualCount > 0 && (this.updateViewportBoundaries(), this._increasePoolIfNeeded(Ga));
  },
  /**
  ...
  _adjustScrollPosition() {
    ...
    if (n !== 0) {
      ...
      !vf && t > 0 && this._resetScrollPosition(t - n);
    }
  },
  /**
   ...
   */
  scrollToIndex(n) {
    if (typeof n != "number" || n < 0 || n > this.items.length - 1 || (Dr(), this._physicalCount === 0))
      return;
  ...
  _debounce(n, t, e) {
    this._debouncers || (this._debouncers = {}), this._debouncers[n] = ie.debounce(this._debouncers[n], e, t.bind(this)), ac(this._debouncers[n]);
  }
};
/**
 * @license
...
class vc {
  ...
  set size(t) {
    ...
    this.__preventElementUpdates = !1, this._isVisible || this._assignModels(), this.elementsContainer.children.length || requestAnimationFrame(() => this._resizeHandler()), this._resizeHandler(), Dr(), this._debounce("_update", this._update, Ne);
  }
  /** @private */
  get _scrollTop() {
...
Object.setPrototypeOf(vc.prototype, yf);
class yc {
  /**
...
function Ya(n, t, e) {
  ...
  return n.forEach(({ path: i }) => {
    if (!i || i.indexOf(".") === -1)
      return;
    const s = i.replace(/\.[^.]*$/u, "");
    Zt(s, e[0]) === void 0 && (console.warn(`Path "${i}" used for ${t} does not exist in all of the items, ${t} is disabled.`), r = !1);
  }), r;
}
function nn(n) {
...
function Za(n, t) {
  return n = nn(n), t = nn(t), n < t ? -1 : n > t ? 1 : 0;
}
function Af(n, t) {
  return n.sort((e, r) => t.map((i) => i.direction === "asc" ? Za(Zt(i.path, e), Zt(i.path, r)) : i.direction === "desc" ? Za(Zt(i.path, r), Zt(i.path, e)) : 0).reduce((i, s) => i !== 0 ? i : s, 0));
}
function kf(n, t) {
  return n.filter((e) => t.every((r) => {
    const i = nn(Zt(r.path, e)), s = nn(r.value).toString().toLowerCase();
    return i.toString().toLowerCase().includes(s);
  }));
}
const Pf = (n) => (t, e) => {
  let r = n ? [...n] : [];
  t.filters && Ya(t.filters, "filtering", r) && (r = kf(r, t.filters)), Array.isArray(t.sortOrders) && t.sortOrders.length && Ya(t.sortOrders, "sorting", r) && (r = Af(r, t.sortOrders));
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const If = !1, Tf = (n) => n, _s = typeof document.head.style.touchAction == "string", Wo = "__polymerGestures", mo = "__polymerGesturesHandled", Go = "__polymerGesturesTouchAction", Xa = 25, Ja = 5, Of = 2, zf = ["mousedown", "mousemove", "mouseup", "click"], Rf = [0, 1, 4, 2], $f = function() {
  try {
...
function Nf(n) {
  if (!(ms(n) || n === "touchend") && _s && xc && If)
    return { passive: !0 };
}
const Df = navigator.userAgent.match(/iP(?:[oa]d|hone)|Android/u), Mf = {
  button: !0,
  command: !0,
  fieldset: !0,
  input: !0,
...
function It(n) {
  ...
  if (t === "mousemove") {
    ...
    return n instanceof window.MouseEvent && !$f && (r = Rf[n.which] || 0), !!(r & 1);
  }
...
const Cc = window.ShadyDOM && window.ShadyDOM.noPatch ? window.ShadyDOM.composedPath : (n) => n.composedPath && n.composedPath() || [], gs = {}, At = [];
function Bf(n, t) {
...
function Vf(n) {
  ...
  if (!n[mo] && (n[mo] = {}, t.startsWith("touch"))) {
    ...
    if (t === "touchstart" && n.touches.length === 1 && (qe.touch.id = l.identifier), qe.touch.id !== l.identifier)
      return;
    _s || (t === "touchstart" || t === "touchmove") && Hf(n);
  }
  const s = n[mo];
  if (!s.skip) {
...
function Hf(n) {
  ...
  if (e === "touchstart")
    ...
    n.cancelable && (r === "none" ? i = !0 : r === "pan-x" ? i = l > s : r === "pan-y" && (i = s > l)), i ? n.preventDefault() : on("track");
  }
}
function Ec(n, t, e) {
  return gs[t] ? (Uf(n, t, e), !0) : !1;
}
function Uf(n, t, e) {
  const r = gs[t], i = r.deps, s = r.name;
  let l = n[Wo];
  l || (n[Wo] = l = {});
  for (let d = 0, f, _; d < i.length; d++)
    f = i[d], !(Df && ms(f) && f !== "click") && (_ = l[f], _ || (l[f] = _ = { _count: 0 }), _._count === 0 && n.addEventListener(f, Vf, Nf(f)), _[s] = (_[s] || 0) + 1, _._count = (_._count || 0) + 1);
  n.addEventListener(t, e), r.touchAction && qf(n, r.touchAction);
}
function bs(n) {
...
function qf(n, t) {
  _s && n instanceof HTMLElement && Ne.run(() => {
...
bs({
  ...
  mousedown(n) {
    ...
    const t = st(n), e = this, r = (s) => {
      It(s) || (Or("up", t, s), er(e.info));
    }, i = (s) => {
      It(s) && Or("up", t, s), er(e.info);
    };
    wc(this.info, r, i), Or("down", t, n);
  },
  /**
   * @this {GestureRecognizer}
   * @param {TouchEvent} e
   ...
   */
  touchstart(n) {
    Or("down", st(n), n.changedTouches[0], n);
  },
  /**
   * @this {GestureRecognizer}
   * @param {TouchEvent} e
   ...
   */
  touchend(n) {
    Or("up", st(n), n.changedTouches[0], n);
  }
});
function Or(n, t, e, r) {
  t && vs(t, n, {
...
bs({
  ...
  info: {
    ...
    /** @this {GestureInfo} */
    addMove(n) {
      this.moves.length > Of && this.moves.shift(), this.moves.push(n);
    },
    movefn: null,
    upfn: null,
    prevent: !1
  ...
  mousedown(n) {
    ...
    const t = st(n), e = this, r = (s) => {
      ...
      Qa(e.info, l, d) && (e.info.state = e.info.started ? s.type === "mouseup" ? "end" : "track" : "start", e.info.state === "start" && on("tap"), e.info.addMove({ x: l, y: d }), It(s) || (e.info.state = "end", er(e.info)), t && go(e.info, t, s), e.info.started = !0);
    }, i = (s) => {
      e.info.started && r(s), er(e.info);
    };
    wc(this.info, r, i), this.info.x = n.clientX, this.info.y = n.clientY;
  },
  /**
   * @this {GestureRecognizer}
   * @param {TouchEvent} e
  ...
  touchmove(n) {
    ...
    Qa(this.info, r, i) && (this.info.state === "start" && on("tap"), this.info.addMove({ x: r, y: i }), go(this.info, t, e), this.info.state = "track", this.info.started = !0);
  },
  /**
   * @this {GestureRecognizer}
   * @param {TouchEvent} e
...
bs({
   ...
   */
  touchend(n) {
    el(this.info, n.changedTouches[0], n);
  }
});
function el(n, t, e) {
  ...
  !s || Mf[
    /** @type {!HTMLElement} */
    s.localName
  ] && s.hasAttribute("disabled") || (isNaN(r) || isNaN(i) || r <= Xa && i <= Xa || Ff(t)) && (n.prevent || vs(s, "tap", {
    x: t.clientX,
    y: t.clientY,
    sourceEvent: t,
    preventer: e
...
const Kf = (n) => class extends n {
  ...
  /** @protected */
  ready() {
    super.ready(), Ec(this, "track", this._onTrackEvent), this._reorderGhost = this.shadowRoot.querySelector('[part="reorder-ghost"]'), this.addEventListener("touchstart", this._onTouchStart.bind(this)), this.addEventListener("touchmove", this._onTouchMove.bind(this)), this.addEventListener("touchend", this._onTouchEnd.bind(this)), this.addEventListener("contextmenu", this._onContextMenu.bind(this));
  }
  /** @private */
  _onContextMenu(e) {
    this.hasAttribute("reordering") && (e.preventDefault(), Xr || this._onTrackEnd());
  }
  /** @private */
  _onTouchStart(e) {
  ...
  _onTrack(e) {
    ...
    if (this._isSwapAllowed(this._draggedColumn, i) && this._isSwappableByPosition(i, e.detail.x)) {
      const s = this._columnTree.findIndex((g) => g.includes(i)), l = this._getColumnsInOrder(s), d = l.indexOf(this._draggedColumn), f = l.indexOf(i), _ = d < f ? 1 : -1;
      for (let g = d; g !== f; g += _)
        this._swapColumnOrders(this._draggedColumn, l[g + _]);
    }
...
const Wf = (n) => class extends n {
  ...
  ready() {
    ...
    Ec(e, "track", this._onHeaderTrack.bind(this)), e.addEventListener("touchmove", (r) => e.hasAttribute("column-resizing") && r.preventDefault()), e.addEventListener(
      "contextmenu",
  ...
  _onHeaderTrack(e) {
    ...
    if (r.getAttribute("part") === "resize-handle") {
      ...
      const l = this.__isRTL, d = e.detail.x, f = Array.from(this.$.header.querySelectorAll('[part~="row"]:last-child [part~="cell"]')), _ = f.find((v) => v._column === s);
      if (_.offsetWidth) {
        const v = getComputedStyle(_._content), z = 10 + parseInt(v.paddingLeft) + parseInt(v.paddingRight) + parseInt(v.borderLeftWidth) + parseInt(v.borderRightWidth) + parseInt(v.marginLeft) + parseInt(v.marginRight);
        let B;
        const H = _.offsetWidth, ee = _.getBoundingClientRect();
        _.hasAttribute("frozen-to-end") ? B = H + (l ? d - ee.right : ee.left - d) : B = H + (l ? ee.left - d : d - ee.right), s.width = `${Math.max(z, B)}px`, s.flexGrow = 0;
      }
      f.sort((v, z) => v._column._order - z._column._order).forEach((v, z, B) => {
        z < B.indexOf(_) && (v._column.width = `${v.offsetWidth}px`, v._column.flexGrow = 0);
      });
...
function Ac({ getItemId: n }, t, e, r = 0, i = 0) {
  ...
  for (const s of t.subCaches) {
    const l = i + t.getFlatIndex(s.parentCacheIndex), d = Ac({ getItemId: n }, s, e, r + 1, l + 1);
    if (d)
      return d;
  }
}
function kc(n, [t, ...e], r = 0) {
  t === 1 / 0 && (t = n.size - 1);
  const i = n.getFlatIndex(t), s = n.getSubCache(t);
  return s && s.flatSize > 0 && e.length ? kc(s, e, r + i + 1) : r + i;
}
/**
 * @license
 * Copyright (c) 2021 - 2024 Vaadin Ltd.
...
class ys {
  ...
  getCacheAndIndex(t) {
    ...
    const { cache: e, index: r } = sn(this, t);
...
class Gf extends EventTarget {
   ...
   */
  getItemContext(e) {
    return Ac({ getItemId: this.getItemId }, this.rootCache, e);
  }
  /**
...
const Yf = (n) => class extends n {
  ...
  constructor() {
    super(), this._dataProviderController = new Gf(this, {
      size: this.size,
      pageSize: this.pageSize,
  ...
  __updateLoading(e, r) {
    const i = nr(e);
    _n(e, "loading", r), nt(i, "loading-row-cell", r), r && (this._generateCellClassNames(e), this._generateCellPartNames(e));
  }
  /**
   ...
   */
  _loadPage(e, r) {
    console.warn("<vaadin-grid> The `_loadPage` method is deprecated and will be removed in Vaadin 25."), this._dataProviderController.__loadCachePage(r, e);
  }
  /** @protected */
  ...
  __debounceClearCache() {
    this.__clearCacheDebouncer = ie.debounce(this.__clearCacheDebouncer, Ne, () => this.clearCache());
  }
  /**
...
const zr = {
  ...
  BELOW: "below",
  EMPTY: "empty"
}, Zf = !("draggable" in document.createElement("div")), Xf = (n) => class extends n {
  static get properties() {
    return {
      /**
  ...
  _onDragStart(e) {
    if (this.rowsDraggable) {
      ...
      Zf ? e.dataTransfer.setDragImage(r) : e.dataTransfer.setDragImage(r, e.clientX - i.left, e.clientY - i.top);
      let s = [r];
      this._isSelected(r._item) && (s = this.__getViewportRows().filter((d) => this._isSelected(d._item)).filter((d) => !this.dragFilter || this.dragFilter(this.__getRowModel(d)))), e.dataTransfer.setData("text", this.__formatDefaultTransferData(s)), Vr(r, { dragstart: s.length > 1 ? `${s.length}` : "" }), this.style.setProperty("--_grid-drag-start-x", `${e.clientX - i.left + 20}px`), this.style.setProperty("--_grid-drag-start-y", `${e.clientY - i.top + 10}px`), requestAnimationFrame(() => {
        Vr(r, { dragstart: !1 }), this.style.setProperty("--_grid-drag-start-x", ""), this.style.setProperty("--_grid-drag-start-y", "");
      });
  ...
  _onDragOver(e) {
    if (this.dropMode) {
      ...
      if (!this._flatSize || this.dropMode === zr.ON_GRID)
        this._dropLocation = et.EMPTY;
      else if (!r || r.parentNode !== this.$.items) {
        if (r)
          return;
        if (this.dropMode === zr.BETWEEN || this.dropMode === zr.ON_TOP_OR_BETWEEN)
          r = Array.from(this.$.items.children).filter((i) => !i.hidden).pop(), this._dropLocation = et.BELOW;
        else
          return;
      } else {
        const i = r.getBoundingClientRect();
        if (this._dropLocation = et.ON_TOP, this.dropMode === zr.BETWEEN) {
          const s = e.clientY - i.top < i.bottom - e.clientY;
          this._dropLocation = s ? et.ABOVE : et.BELOW;
        } else this.dropMode === zr.ON_TOP_OR_BETWEEN && (e.clientY - i.top < i.height / 3 ? this._dropLocation = et.ABOVE : e.clientY - i.top > i.height / 3 * 2 && (this._dropLocation = et.BELOW));
      }
      if (r && r.hasAttribute("drop-disabled")) {
        this._dropLocation = void 0;
        return;
      }
      e.stopPropagation(), e.preventDefault(), this._dropLocation === et.EMPTY ? this.toggleAttribute("dragover", !0) : r ? (this._dragOverItem = r._item, r.getAttribute("dragover") !== this._dropLocation && Ua(r, { dragover: this._dropLocation })) : this._clearDragStyles();
    }
  }
  /** @private */
  __dndAutoScroll(e) {
  ...
  /** @protected */
  _clearDragStyles() {
    this.removeAttribute("dragover"), Se(this.$.items, (e) => {
      Ua(e, { dragover: null });
    });
  }
  /** @private */
...
const Jf = (n) => class extends n {
  ...
  _updateColumnTree() {
    ...
    Pc(e, this._columnTree) || (e.forEach((r) => {
      r.forEach((i) => {
...
const tp = (n) => class extends n {
  ...
  _focusedCellChanged(e, r) {
    r && us(r, "part", "focused-cell"), e && pn(e, "part", "focused-cell");
  }
  /** @private */
  _interactingChanged() {
  ...
  _onNavigationKeyDown(e, r) {
    ...
    if (this.__rowFocusMode && !s || !this.__rowFocusMode && !l)
      return;
    const _ = i ? "ArrowLeft" : "ArrowRight", g = i ? "ArrowRight" : "ArrowLeft";
    if (r === _) {
      if (this.__rowFocusMode) {
  ...
  __navigateRows(e, r, i) {
    ...
    if (i) {
      ...
      if (l === this.$.items) {
        ...
        g ? _ = e === 0 : _ = e === 1 && this._isDetailsOpened(v) || e === -1 && f !== s && this._isDetailsOpened(z), _ !== g && (e === 1 && _ || e === -1 && !_) && (f = s);
      }
    }
  ...
  _onCellNavigation(e, r, i) {
    ...
    const _ = this.__isDetailsCell(e), g = s.parentNode, v = this.__getIndexInGroup(s, this._focusedItemIndex);
    if (this._focusedColumnOrder === void 0 && (_ ? this._focusedColumnOrder = 0 : this._focusedColumnOrder = this._getColumns(g, v).filter((z) => !z.hidden)[f]._order), d)
      ...
      ), ae = i === 0 && _ ? se : Math.max(0, Math.min(se + r, ee));
  ...
  _onInteractionKeyDown(e, r) {
    ...
    if (this.interacting !== l && d !== null)
      if (l) {
        ...
        [...d._content.querySelectorAll("*")].find((_) => this._isFocusable(_));
  ...
  _scrollHorizontallyToCell(e) {
    ...
    for (let _ = s + 1; _ < i.children.length; _++) {
      const g = i.children[_];
      if (!(g.hasAttribute("hidden") || this.__isDetailsCell(g)) && (g.hasAttribute("frozen") || g.hasAttribute("frozen-to-end"))) {
...
const rp = (n) => class extends n {
  ...
  _rowDetailsRendererChanged(e) {
    e && this._columnTree && Se(this.$.items, (r) => {
...
gn.style.clip = "rect(0px, 0px, 0px, 0px)";
gn.setAttribute("aria-live", "polite");
...
function np(n, t) {
  ...
  !r || r.size === 0 ? n.removeAttribute(t) : pn(n, t, fn(r)), e.delete(n);
}
function vo(n, t, e = { newId: null, oldId: null, fromUser: !1 }) {
  ...
  s && (d ? r || l.delete(n) : Tc(n, t), Ic(n, t)), us(n, t, i);
  const f = r || fn(d);
  f && pn(n, t, f);
}
function op(n, t) {
...
class sp {
  ...
  __setAriaLabelToAttribute(t) {
    this.__target && (t ? (op(this.__target, "aria-labelledby"), this.__target.setAttribute("aria-label", t)) : this.__label && (np(this.__target, "aria-labelledby"), this.__target.removeAttribute("aria-label")));
  }
  /**
...
class ap {
  ...
  get __focusedElementIndex() {
    ...
    return t.indexOf(t.filter(hc).pop());
  }
  hostConnected() {
...
const Ni = new ResizeObserver((n) => {
  ...
  (n) => class extends n {
    ...
    /** @protected */
    connectedCallback() {
      if (super.connectedCallback(), Ni.observe(this), this._observeParent) {
        const e = this.parentNode instanceof ShadowRoot ? this.parentNode.host : this.parentNode;
        e.resizables || (e.resizables = /* @__PURE__ */ new Set(), Ni.observe(e)), e.resizables.add(this), this.__parent = e;
      }
    }
    /** @protected */
    disconnectedCallback() {
      super.disconnectedCallback(), Ni.unobserve(this);
      const e = this.__parent;
      if (this._observeParent && e) {
        const r = e.resizables;
        r && (r.delete(this), r.size === 0 && Ni.unobserve(e)), this.__parent = null;
      }
    }
    /**
...
const rl = {
  ...
  /** @private */
  _scheduleScrolling() {
    this._scrollingFrame || (this._scrollingFrame = requestAnimationFrame(() => this.$.scroller.toggleAttribute("scrolling", !0))), this._debounceScrolling = ie.debounce(this._debounceScrolling, Ke.after(rl.SCROLLING), () => {
  ...
  _afterScroll() {
    this.__updateHorizontalScrollPosition(), this.hasAttribute("reordering") || this._scheduleScrolling(), this.hasAttribute("navigating") || this._hideTooltip(!0), this._updateOverflow(), this._debounceColumnContentVisibility = ie.debounce(
      ...
      Ke.after(rl.UPDATE_CONTENT_VISIBILITY),
      () => {
    ...
    ), this._firefox && !rn(this) && this.__previousVisible !== !1 && (this.__memorizedScrollTop = this._scrollTop);
  }
  /** @private */
  ...
  __doUpdateOverflow() {
    ...
    const i = tl(r, this.getAttribute("dir"));
  ...
  /** @protected */
  _frozenCellsChanged() {
    this._debouncerCacheElements = ie.debounce(this._debouncerCacheElements, Ne, () => {
  ...
  __updateHorizontalScrollPosition() {
    if (!this._columnTree)
      return;
    const e = this.$.table.scrollWidth, r = this.$.table.clientWidth, i = Math.max(0, this.$.table.scrollLeft), s = tl(this.$.table, this.getAttribute("dir")), l = `translate(${-i}px, 0)`;
    ...
    const _ = this.__isRTL ? s : i + r - e, g = `translate(${_}px, 0)`;
    let v = g;
    if (this._lazyColumns && this._areSizerCellsAssigned()) {
      ...
      v = `translate(${_ + (se - H) + this.__lazyColumnsStart}px, 0)`;
    }
...
const hp = (n) => class extends n {
  ...
  static setDefaultMultiSortPriority(e) {
    il = ["append", "prepend"].includes(e) ? e : "prepend";
  }
  /** @protected */
  ready() {
...
const pp = (n) => class extends Sf(
  ...
  _getRowContainingNode(t) {
    const e = lc("vaadin-grid-cell-content", t);
  ...
  /** @protected */
  ready() {
    super.ready(), this.__virtualizer = new yc({
    ...
    ).observe(this.$.table), cs(this), this._tooltipController = new bc(this), this.addController(this._tooltipController), this._tooltipController.setManual(!0);
  }
  /** @private */
  ...
  __getDistributedWidth(t, e) {
    ...
    if (!e)
      return r;
    const i = t, s = r, l = i._visibleChildColumns.map((g) => this.__getIntrinsicWidth(g)).reduce((g, v) => g + v, 0), d = Math.max(0, s - l), _ = this.__getIntrinsicWidth(e) / l * d;
    return this.__getIntrinsicWidth(e) + _;
  }
  /**
  ...
  recalculateColumnWidths() {
    if (!this._columnTree)
      return;
    if (rn(this) || this._dataProviderController.isLoading()) {
  ...
  __tryToRecalculateColumnWidthsIfPending() {
    if (!this.__pendingRecalculateColumnWidths || rn(this) || this._dataProviderController.isLoading() || [...this.$.items.children].some((r) => r.index === void 0))
      return;
  ...
  _createCell(t, e) {
    ...
    l.id = i.replace("-content-", "-"), l.setAttribute("role", t === "td" ? "gridcell" : "columnheader"), !Ka && !Ko && (l.addEventListener("mouseenter", (f) => {
    ...
    return l._content = s, s.addEventListener("mousedown", () => {
      if (ff) {
        const f = (_) => {
          const g = s.contains(this.getRootNode().activeElement), v = _.composedPath().includes(s);
  ...
  _updateRow(t, e, r = "body", i = !1, s = !1) {
    ...
    or(t, (d) => {
      d._vacant = !0;
    }), t.innerHTML = "", r === "body" && (t.__cells = [], t.__detailsCell = null), e.filter((d) => !d.hidden).forEach((d, f, _) => {
      let g;
      if (r === "body") {
        ...
        if ((!d._bodyContentHidden || v) && t.appendChild(g), v && (d._sizerCell = g), f === _.length - 1 && this.rowDetailsRenderer) {
  ...
  _updateItem(t, e) {
    ...
    this._toggleDetailsCell(t, r.detailsOpened), this._a11yUpdateRowLevel(t, r.level), this._a11yUpdateRowSelected(t, r.selected), this._updateRowStateParts(t, r), this._generateCellClassNames(t, r), this._generateCellPartNames(t, r), this._filterDragAndDrop(t, r), Se(t, (i) => {
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
fe("vaadin-grid", _p, { moduleId: "vaadin-grid-styles" });
class mp extends pp(dc(ti(ii(Dt)))) {
  static get template() {
    return dr`
      <div
        id="scroller"
...
`;
fe("vaadin-item", Oc, { moduleId: "lumo-item" });
const gp = X`
  :host {
...
`;
fe("vaadin-combo-box-item", [Oc, gp], {
...
`, yp = [Cs, Es, vp];
fe("", yp, { moduleId: "lumo-menu-overlay" });
const xp = X`
  [part='content'] {
    padding: 0;
  }
...
`;
fe("", zc, { moduleId: "lumo-field-button" });
/**
 * @license
 * Copyright (c) 2017 - 2024 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
`;
fe("", Rc, { moduleId: "lumo-required-field" });
/**
 * @license
 * Copyright (c) 2017 - 2024 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
`;
fe("vaadin-combo-box", [$c, Ap], { moduleId: "lumo-combo-box" });
/**
 * @license
 * Copyright (c) 2021 - 2024 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
const kp = (n) => class extends n {
  static get properties() {
    return {
      /**
       * If true, the user cannot interact with this element.
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
fe("vaadin-input-container", Pp, { moduleId: "vaadin-input-container-styles" });
class Sp extends kp(ti(ri(Dt))) {
  static get is() {
...
function zp() {
  Yo = !0, requestAnimationFrame(function() {
    Yo = !1, Rp(Op), setTimeout(function() {
      $p(Nc);
    });
  });
}
 ...
 */
let Wt = /* @__PURE__ */ new WeakMap(), Di = /* @__PURE__ */ new WeakMap(), Mi = {}, xo = 0;
const nl = (n) => n && n.nodeType === Node.ELEMENT_NODE, wo = (...n) => {
  console.error(`Error: ${n.join(" ")}. Skip setting aria-hidden.`);
}, Dp = (n, t) => nl(n) ? t.map((e) => {
  if (!nl(e))
...
}).filter((e) => !!e) : (wo(n, "is not a valid element"), []), Mp = (n, t, e, r) => {
  const i = Dp(t, Array.isArray(n) ? n : [n]);
  Mi[e] || (Mi[e] = /* @__PURE__ */ new WeakMap());
  const s = Mi[e], l = [], d = /* @__PURE__ */ new Set(), f = new Set(i), _ = (v) => {
    if (!v || d.has(v))
      return;
    d.add(v);
    const z = v.assignedSlot;
    z && _(z), _(v.parentNode || v.host);
  };
  i.forEach(_);
  const g = (v) => {
    if (!v || f.has(v))
    ...
    (z ? [...v.children, ...z.children] : [...v.children]).forEach((H) => {
      if (!["template", "script", "style"].includes(H.localName))
        if (d.has(H))
          ...
          Wt.set(H, ae), s.set(H, re), l.push(H), ae === 1 && se && Di.set(H, !0), re === 1 && H.setAttribute(e, "true"), se || H.setAttribute(r, "true");
        }
    });
  };
  return g(t), d.clear(), xo += 1, () => {
    l.forEach((v) => {
      ...
      Wt.set(v, z), s.set(v, B), z || (Di.has(v) ? Di.delete(v) : v.removeAttribute(r)), B || v.removeAttribute(e);
    }), xo -= 1, xo || (Wt = /* @__PURE__ */ new WeakMap(), Wt = /* @__PURE__ */ new WeakMap(), Di = /* @__PURE__ */ new WeakMap(), Mi = {});
  };
}, Fp = (n, t = document.body, e = "data-aria-hidden") => {
  const r = Array.from(Array.isArray(n) ? n : [n]);
  return t && r.push(...Array.from(t.querySelectorAll("[aria-live]"))), Mp(r, t, e, "aria-hidden");
};
/**
 * @license
 * Copyright (c) 2021 - 2024 Vaadin Ltd.
...
const Bp = (n) => class extends ii(n) {
  ...
  constructor() {
    super(), this.__ariaModalController = new Lp(this), this.__focusTrapController = new ap(this), this.__focusRestorationController = new lp();
  }
  /** @protected */
  ready() {
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
const Ui = () => Array.from(document.body.children).filter((n) => n instanceof HTMLElement && n._hasOverlayStackMixin && !n.hasAttribute("closing")).sort((n, t) => n.__zIndex - t.__zIndex || 0), Vp = (n) => n === Ui().pop(), Hp = (n) => class extends n {
  constructor() {
  ...
  bringToFront() {
    let e = "";
    const r = Ui().filter((i) => i !== this).pop();
    r && (e = r.__zIndex + 1), this.style.zIndex = e, this.__zIndex = e || parseFloat(getComputedStyle(this).zIndex);
  }
  /** @protected */
  _enterModalState() {
    document.body.style.pointerEvents !== "none" && (this._previousDocumentPointerEvents = document.body.style.pointerEvents, document.body.style.pointerEvents = "none"), Ui().forEach((e) => {
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
const Up = (n) => class extends Bp(Hp(n)) {
  static get properties() {
    return {
      /**
  ...
  _rendererOrDataChanged(e, r, i, s) {
    ...
    this._oldRenderer = e;
    const _ = this._oldOpened !== s;
    this._oldOpened = s, d && f && (this.innerHTML = "", delete this._$litPart$), s && e && (d || _ || l) && this.requestContentUpdate();
  }
  /** @private */
  _modelessChanged(e) {
  ...
  /** @private */
  _openedChanged(e, r) {
    e ? (this._saveFocus(), this._animatedOpening(), Np(this, () => {
      this._trapFocus();
...
const Co = {
  ...
  __addUpdatePositionEventListeners() {
    window.visualViewport.addEventListener("resize", this._updatePosition), window.visualViewport.addEventListener("scroll", this.__onScroll, !0), this.__positionTargetAncestorRootNodes = Kh(this.positionTarget), this.__positionTargetAncestorRootNodes.forEach((e) => {
  ...
  __overlayOpenedChanged(e, r) {
    if (this.__removeUpdatePositionEventListeners(), r && (r.__overlay = null, ol.unobserve(r), e && (this.__addUpdatePositionEventListeners(), r.__overlay = this, ol.observe(r))), e) {
  ...
  _updatePosition() {
    ...
    const d = this.getBoundingClientRect(), f = this.__calculatePositionInOneDimension(
      ...
      this,
      r
    ), _ = this.__calculatePositionInOneDimension(
      e,
      d,
    ...
    Object.assign(this.style, f, _), this.toggleAttribute("bottom-aligned", !r), this.toggleAttribute("top-aligned", r), this.toggleAttribute("end-aligned", !l), this.toggleAttribute("start-aligned", l);
  }
  ...
  __shouldAlignStart(e, r, i, s, l, d, f) {
    const _ = i - e[d ? f.end : f.start] - s[f.end], g = e[d ? f.start : f.end] - s[f.start], v = l ? _ : g, B = v > (l ? g : _) || v > r;
    return l === B;
  }
  /**
  ...
  __calculatePositionInOneDimension(e, r, i, s, l, d) {
    const f = d ? s.start : s.end, _ = d ? s.end : s.start, g = parseFloat(l.style[f] || getComputedStyle(l)[f]), v = this.__adjustBottomProperty(f, s, g), z = r[d ? s.start : s.end] - e[i === d ? s.end : s.start], B = v ? `${v}px` : `${g + z * (d ? -1 : 1)}px`;
    return {
      [f]: B,
      [_]: ""
    };
...
`;
fe("vaadin-combo-box-overlay", [jp, Wp], {
  moduleId: "vaadin-combo-box-overlay-styles"
});
class Gp extends Kp(Up(ri(ti(Dt)))) {
  static get is() {
...
const Yp = (n) => class extends n {
  ...
  /** @protected */
  ready() {
    super.ready(), this.setAttribute("role", "listbox"), this.id = `${this.localName}-${gc()}`, this.__hostTagName = this.constructor.is.replace("-scroller", ""), this.addEventListener("click", (e) => e.stopPropagation()), this.__patchWheelOverScrolling();
  }
  /**
  ...
  scrollIntoView(e) {
    ...
    const s = [...this.children].find(
      (_) => !_.hidden && _.index === this.__virtualizer.lastVisibleIndex
    );
    if (!s || e !== s.index)
      return;
...
const Qp = me(
  (n) => class extends n {
    ...
    /** @private */
    __applySlotStyles() {
      const e = this.getRootNode(), r = Xp(e);
      this.slotStyles.forEach((i) => {
        r.has(i) || (Jp(i, e), r.add(i));
      });
    }
  }
);
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
const e_ = (n) => class extends As(xs(n)) {
  static get properties() {
    return {
      /**
  ...
  _onClearButtonMouseDown(e) {
    e.preventDefault(), Xr || this.inputElement.focus();
  }
  /**
...
const n_ = me(
  (n) => class extends ii(n) {
    ...
    constructor() {
      super(), this._labelController = new i_(this), this._labelController.addEventListener("slot-content-changed", (e) => {
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
const o_ = (n) => class extends Ps(n_(ii(n))) {
  static get properties() {
    return {
      /**
  ...
  constructor() {
    super(), this._fieldAriaController = new sp(this), this._helperController = new r_(this), this._errorController = new t_(this), this._errorController.addEventListener("slot-content-changed", (e) => {
...
const b_ = (n) => class extends m_(
  ...
  ready() {
    ...
    this.addEventListener("mousedown", e), this.addEventListener("touchstart", e), cs(this), this.addController(new g_(this));
  }
  /** @protected */
  disconnectedCallback() {
  ...
  /** @private */
  // eslint-disable-next-line max-params
  _updateScroller(e, r, i, s, l, d, f, _, g) {
  ...
  /** @protected */
  _isInputFocused() {
    return this.inputElement && hc(this.inputElement);
  }
  /** @private */
  ...
  _openedChanged(e, r) {
    if (r === void 0)
      return;
    e ? (!this._isInputFocused() && !Xr && this.inputElement && this.inputElement.focus(), this._overlayElement.restoreFocusOnClose = !0) : this._onClosed();
  ...
  _toggleElementChanged(e) {
    e && (e.addEventListener("mousedown", (r) => r.preventDefault()), e.addEventListener("click", () => {
      Xr && !this._isInputFocused() && document.activeElement.blur();
    }));
  }
  /**
   ...
   */
  _valueChanged(e, r) {
    e === "" && r === void 0 || (sl(e) ? (this._getItemValue(this.selectedItem) !== e && this._selectItemForValue(e), !this.selectedItem && this.allowCustomValue && (this._inputElementValue = e), this._toggleHasValue(this._hasValue)) : this.selectedItem = null, this._clearFilter(), this._lastCommittedValue = void 0);
  }
  /** @private */
  ...
  __getItemIndexByValue(e, r) {
    return !e || !sl(r) ? -1 : al(e, (i) => this._getItemValue(i) === r);
  }
  /**
  ...
  __getItemIndexByLabel(e, r) {
    return !e || !r ? -1 : al(e, (i) => this._getItemLabel(i).toString().toLowerCase() === r.toString().toLowerCase());
  }
  /** @private */
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
fe("vaadin-combo-box", p_, { moduleId: "vaadin-combo-box-styles" });
class v_ extends __(
  b_(d_(a_(ti(dc(Dt)))))
) {
  static get is() {
  ...
  ready() {
    ...
    ), this.addController(new c_(this.inputElement, this._labelController)), this._tooltipController = new bc(this), this.addController(this._tooltipController), this._tooltipController.setPosition("top"), this._tooltipController.setAriaTarget(this.inputElement), this._tooltipController.setShouldShow((t) => !t.opened), this._positionTarget = this.shadowRoot.querySelector('[part="input-field"]'), this._toggleElement = this.$.toggleButton;
  }
  /**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const x_ = { attribute: !0, type: String, converter: Yi, reflect: !1, hasChanged: rs }, w_ = (n = x_, t, e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ji = globalThis, Is = ji.ShadowRoot && (ji.ShadyCSS === void 0 || ji.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Bc = Symbol(), ll = /* @__PURE__ */ new WeakMap();
let C_ = class {
  constructor(t, e, r) {
    if (this._$cssResult$ = !0, r !== Bc) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
    this.cssText = t, this.t = e;
  }
  get styleSheet() {
    let t = this.o;
    ...
    if (Is && t === void 0) {
      const r = e !== void 0 && e.length === 1;
      r && (t = ll.get(e)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), r && ll.set(e, t));
    }
    return t;
  }
  toString() {
...
const E_ = (n) => new C_(typeof n == "string" ? n : n + "", void 0, Bc), A_ = (n, t) => {
  if (Is) n.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
  else for (const e of t) {
    const r = document.createElement("style"), i = ji.litNonce;
    i !== void 0 && r.setAttribute("nonce", i), r.textContent = e.cssText, n.appendChild(r);
  }
}, cl = Is ? (n) => n : (n) => n instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const r of t.cssRules) e += r.cssText;
  return E_(e);
})(n) : n;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: k_, defineProperty: P_, getOwnPropertyDescriptor: S_, getOwnPropertyNames: I_, getOwnPropertySymbols: T_, getPrototypeOf: O_ } = Object, at = globalThis, dl = at.trustedTypes, z_ = dl ? dl.emptyScript : "", ko = at.reactiveElementPolyfillSupport, Hr = (n, t) => n, an = { toAttribute(n, t) {
  switch (t) {
    case Boolean:
      n = n ? z_ : null;
      break;
  ...
  return e;
} }, Ts = (n, t) => !k_(n, t), ul = { attribute: !0, type: String, converter: an, reflect: !1, hasChanged: Ts };
...
class Yt extends HTMLElement {
  ...
  static createProperty(t, e = ul) {
    if (e.state && (e.attribute = !1), this._$Ei(), this.elementProperties.set(t, e), !e.noAccessor) {
      const r = Symbol(), i = this.getPropertyDescriptor(t, r, e);
      i !== void 0 && P_(this.prototype, t, i);
    }
  }
  static getPropertyDescriptor(t, e, r) {
    const { get: i, set: s } = S_(this.prototype, t) ?? { get() {
      return this[e];
    }, set(l) {
      this[e] = l;
    } };
  ...
  static getPropertyOptions(t) {
    return this.elementProperties.get(t) ?? ul;
  }
  static _$Ei() {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(Hr("properties"))) {
      const e = this.properties, r = [...I_(e), ...T_(e)];
      for (const i of r) this.createProperty(i, e[i]);
    }
    const t = this[Symbol.metadata];
    if (t !== null) {
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      const r = new Set(t.flat(1 / 0).reverse());
      for (const i of r) e.unshift(cl(i));
    } else t !== void 0 && e.push(cl(t));
    return e;
  }
  static _$Eu(t, e) {
    const r = e.attribute;
  ...
  _$EC(t, e) {
    ...
    const r = this.constructor.elementProperties.get(t), i = this.constructor._$Eu(t, r);
    if (i !== void 0 && r.reflect === !0) {
      const l = (((s = r.converter) == null ? void 0 : s.toAttribute) !== void 0 ? r.converter : an).toAttribute(e, r.type);
      this._$Em = t, l == null ? this.removeAttribute(i) : this.setAttribute(i, l), this._$Em = null;
    }
  }
  _$AK(t, e) {
    ...
    const r = this.constructor, i = r._$Eh.get(t);
    if (i !== void 0 && this._$Em !== i) {
      const l = r.getPropertyOptions(i), d = typeof l.converter == "function" ? { fromAttribute: l.converter } : ((s = l.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? l.converter : an;
      this._$Em = i, this[i] = d.fromAttribute(e, l.type), this._$Em = null;
    }
  }
  requestUpdate(t, e, r) {
...
Yt.elementStyles = [], Yt.shadowRootOptions = { mode: "open" }, Yt[Hr("elementProperties")] = /* @__PURE__ */ new Map(), Yt[Hr("finalized")] = /* @__PURE__ */ new Map(), ko == null || ko({ ReactiveElement: Yt }), (at.reactiveElementVersions ?? (at.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ur = globalThis, ln = Ur.trustedTypes, hl = ln ? ln.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, Vc = "$lit$", rt = `lit$${(Math.random() + "").slice(9)}$`, Hc = "?" + rt, R_ = `<${Hc}>`, $t = document, Jr = () => $t.createComment(""), Qr = (n) => n === null || typeof n != "object" && typeof n != "function", Uc = Array.isArray, $_ = (n) => Uc(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", Po = `[ 	
\f\r]`, Rr = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, fl = /-->/g, pl = />/g, wt = RegExp(`>|${Po}(?:([^\\s"'>=/]+)(${Po}*=${Po}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), _l = /'/g, ml = /"/g, jc = /^(?:script|style|textarea|title)$/i, N_ = (n) => (t, ...e) => ({ _$litType$: n, strings: t, values: e }), it = N_(1), ar = Symbol.for("lit-noChange"), he = Symbol.for("lit-nothing"), gl = /* @__PURE__ */ new WeakMap(), kt = $t.createTreeWalker($t, 129);
function qc(n, t) {
  if (!Array.isArray(n) || !n.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return hl !== void 0 ? hl.createHTML(t) : t;
}
const D_ = (n, t) => {
  const e = n.length - 1, r = [];
  let i, s = t === 2 ? "<svg>" : "", l = Rr;
  for (let d = 0; d < e; d++) {
    const f = n[d];
    let _, g, v = -1, z = 0;
    for (; z < f.length && (l.lastIndex = z, g = l.exec(f), g !== null); ) z = l.lastIndex, l === Rr ? g[1] === "!--" ? l = fl : g[1] !== void 0 ? l = pl : g[2] !== void 0 ? (jc.test(g[2]) && (i = RegExp("</" + g[2], "g")), l = wt) : g[3] !== void 0 && (l = wt) : l === wt ? g[0] === ">" ? (l = i ?? Rr, v = -1) : g[1] === void 0 ? v = -2 : (v = l.lastIndex - g[2].length, _ = g[1], l = g[3] === void 0 ? wt : g[3] === '"' ? ml : _l) : l === ml || l === _l ? l = wt : l === fl || l === pl ? l = Rr : (l = wt, i = void 0);
    const B = l === wt && n[d + 1].startsWith("/>") ? " " : "";
    s += l === Rr ? f + R_ : v >= 0 ? (r.push(_), f.slice(0, v) + Vc + f.slice(v) + rt + B) : f + rt + (v === -2 ? d : B);
  }
  return [qc(n, s + (n[e] || "<?>") + (t === 2 ? "</svg>" : "")), r];
};
class ei {
  constructor({ strings: t, _$litType$: e }, r) {
    let i;
    this.parts = [];
    let s = 0, l = 0;
    const d = t.length - 1, f = this.parts, [_, g] = D_(t, e);
    if (this.el = ei.createElement(_, r), kt.currentNode = this.el.content, e === 2) {
      const v = this.el.content.firstChild;
      v.replaceWith(...v.childNodes);
    }
    for (; (i = kt.nextNode()) !== null && f.length < d; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const v of i.getAttributeNames()) if (v.endsWith(Vc)) {
          const z = g[l++], B = i.getAttribute(v).split(rt), H = /([.?@])?(.*)/.exec(z);
          f.push({ type: 1, index: s, name: H[2], strings: B, ctor: H[1] === "." ? F_ : H[1] === "?" ? L_ : H[1] === "@" ? B_ : bn }), i.removeAttribute(v);
        ...
        if (jc.test(i.tagName)) {
          ...
          if (z > 0) {
            i.textContent = ln ? ln.emptyScript : "";
            for (let B = 0; B < z; B++) i.append(v[B], Jr()), kt.nextNode(), f.push({ type: 2, index: ++s });
            i.append(v[z], Jr());
          }
        }
      } else if (i.nodeType === 8) if (i.data === Hc) f.push({ type: 2, index: s });
      else {
        let v = -1;
...
class M_ {
  ...
  u(t) {
    ...
    for (; f !== void 0; ) {
      if (l === f.index) {
        let _;
        f.type === 2 ? _ = new ni(s, s.nextSibling, this, t) : f.type === 1 ? _ = new f.ctor(s, f.name, f.strings, this, t) : f.type === 6 && (_ = new V_(s, this, t)), this._$AV.push(_), f = r[++d];
      }
...
class ni {
  ...
  _$AI(t, e = this) {
    t = lr(this, t, e), Qr(t) ? t === he || t == null || t === "" ? (this._$AH !== he && this._$AR(), this._$AH = he) : t !== this._$AH && t !== ar && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : $_(t) ? this.k(t) : this._(t);
  }
  S(t) {
    return this._$AA.parentNode.insertBefore(t, this._$AB);
  }
  ...
  _(t) {
    this._$AH !== he && Qr(this._$AH) ? this._$AA.nextSibling.data = t : this.T($t.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var s;
    const { values: e, _$litType$: r } = t, i = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = ei.createElement(qc(r.h, r.h[0]), this.options)), r);
    if (((s = this._$AH) == null ? void 0 : s._$AD) === i) this._$AH.p(e);
    else {
      const l = new M_(i, this), d = l.u(this.options);
      l.p(e), this.T(d), this._$AH = l;
    }
  }
  _$AC(t) {
    let e = gl.get(t.strings);
    return e === void 0 && gl.set(t.strings, e = new ei(t)), e;
  }
  k(t) {
    Uc(this._$AH) || (this._$AH = [], this._$AR());
    const e = this._$AH;
    let r, i = 0;
    for (const s of t) i === e.length ? e.push(r = new ni(this.S(Jr()), this.S(Jr()), this, this.options)) : r = e[i], r._$AI(s), i++;
    i < e.length && (this._$AR(r && r._$AB.nextSibling, i), e.length = i);
  }
  _$AR(t = this._$AA.nextSibling, e) {
    var r;
...
class bn {
  ...
  _$AI(t, e = this, r, i) {
    const s = this.strings;
    let l = !1;
    if (s === void 0) t = lr(this, t, e, 0), l = !Qr(t) || t !== this._$AH && t !== ar, l && (this._$AH = t);
    else {
      const d = t;
      let f, _;
      for (t = s[0], f = 0; f < s.length - 1; f++) _ = lr(this, d[r + f], e, f), _ === ar && (_ = this._$AH[f]), l || (l = !Qr(_) || _ !== this._$AH[f]), _ === he ? t = he : t !== he && (t += (_ ?? "") + s[f + 1]), this._$AH[f] = _;
    }
    l && !i && this.j(t);
  }
  j(t) {
...
const So = Ur.litHtmlPolyfillSupport;
So == null || So(ei, ni), (Ur.litHtmlVersions ?? (Ur.litHtmlVersions = [])).push("3.1.2");
const H_ = (n, t, e) => {
  const r = (e == null ? void 0 : e.renderBefore) ?? t;
  let i = r._$litPart$;
  if (i === void 0) {
    const s = (e == null ? void 0 : e.renderBefore) ?? null;
    r._$litPart$ = i = new ni(t.insertBefore(Jr(), s), s, void 0, e ?? {});
  }
  return i._$AI(n), i;
};
/**
...
let tr = class extends Yt {
  ...
  update(t) {
    const e = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = H_(e, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var t;
    super.connectedCallback(), (t = this._$Do) == null || t.setConnected(!0);
...
var Cl;
tr._$litElement$ = !0, tr.finalized = !0, (Cl = globalThis.litElementHydrateSupport) == null || Cl.call(globalThis, { LitElement: tr });
...
class U_ extends tr {
  ...
  onAppMessage(t) {
    console.log("Unhandled AppMessage received", t.detail), this.addAppError(t.detail.headline + "<br>" + t.detail.body);
  }
  firstUpdated(t) {
  ...
  render() {
    let t;
    return this.apiContext && this.apiContext.status === Lc ? t = this.apiRender() : this.apiContext && this.apiContext.status === Zo ? t = this.renderApiError() : t = this.renderNoContextYet(), it`
            <style>
                .system-message {
                    display: flex;
                    flex-direction: row;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const j_ = { attribute: !0, type: String, converter: an, reflect: !1, hasChanged: Ts }, q_ = (n = j_, t, e) => {
  const { kind: r, metadata: i } = e;
  let s = globalThis.litPropertyMetadata.get(i);
  if (s === void 0 && globalThis.litPropertyMetadata.set(i, s = /* @__PURE__ */ new Map()), s.set(e.name, n), r === "accessor") {
    const { name: l } = e;
...
function K_(n) {
  return (t, e) => typeof e == "object" ? q_(n, t, e) : ((r, i, s) => {
    const l = i.hasOwnProperty(s);
    return i.constructor.createProperty(s, l ? { ...r, wrapped: !0 } : r), l ? Object.getOwnPropertyDescriptor(i, s) : void 0;
  })(n, t, e);
}
 ...
 */
function W_(n) {
  return K_({ ...n, state: !0, attribute: !1 });
}
var G_ = function(n, t, e, r) {
  var i = arguments.length, s = i < 3 ? t : r, l;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") s = Reflect.decorate(n, t, e, r);
  else for (var d = n.length - 1; d >= 0; d--) (l = n[d]) && (s = (i < 3 ? l(s) : i > 3 ? l(t, e, s) : l(t, e)) || s);
...
G_([
  W_()
], vn.prototype, "showProgress", void 0);
...
function Oo(n, t, e, r = "") {
  let i = new Y_(t, e, r);
  n.dispatchEvent(new CustomEvent("send-message", { bubbles: !0, composed: !0, detail: i }));
}
function Z_(n, t) {
  return n && t in n ? n[t] : t.replace("_", " ");
}
function X_(n, t, e = "", r = null) {
  if (e && (e += ": "), t.response) {
    if (t.response.status == 403 || t.response.status == 401) {
      Oo(n, To, `${e}You are not logged in properly or your session has timed out`, '<a href="/logout">Please log in again.</a>');
      return;
    }
    r ? r(t) : Oo(n, To, `${e}Kiosk server responded with an error.`, `(${t.msg}). 
                The server might be down or perhaps you are not logged in properly.`);
  } else {
    Oo(n, To, `${e}Kiosk server responded with a network error.`, `(${t}). 
            The server might be down or perhaps you are not logged in properly.`);
    return;
  }
}
...
(function(n, t) {
  (function(e, r) {
    ...
    var s = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : bl, l = Object.keys, d = Array.isArray;
    function f(o, a) {
    ...
    var _ = Object.getPrototypeOf, g = {}.hasOwnProperty;
    function v(o, a) {
      return g.call(o, a);
    }
    function z(o, a) {
      typeof a == "function" && (a = a(_(o))), (typeof Reflect > "u" ? l : Reflect.ownKeys)(a).forEach(function(c) {
        H(o, c, a[c]);
      });
    }
    ...
    function ge(o, a) {
      ...
      var m = a.indexOf(".");
      if (m !== -1) {
        var b = o[a.substr(0, m)];
        return b == null ? void 0 : ge(b, a.substr(m + 1));
      }
    }
    function Ce(o, a, c) {
      if (o && a !== void 0 && !("isFrozen" in Object && Object.isFrozen(o))) if (typeof a != "string" && "length" in a) {
        ...
        var p, m, b = a.indexOf(".");
        b !== -1 ? (p = a.substr(0, b), (m = a.substr(b + 1)) === "" ? c === void 0 ? d(o) && !isNaN(parseInt(p)) ? o.splice(p, 1) : delete o[p] : o[p] = c : Ce(b = !(b = o[p]) || !v(o, p) ? o[p] = {} : b, m, c)) : c === void 0 ? d(o) && !isNaN(parseInt(a)) ? o.splice(a, 1) : delete o[a] : o[a] = c;
      }
    }
    function Os(o) {
      var a, c = {};
    ...
    var He = "BigUint64Array,BigInt64Array,Array,Boolean,String,Date,RegExp,Blob,File,FileList,FileSystemFileHandle,FileSystemDirectoryHandle,ArrayBuffer,DataView,Uint8ClampedArray,ImageBitmap,ImageData,Map,Set,CryptoKey".split(",").concat(zs([8, 16, 32, 64].map(function(o) {
      return ["Int", "Uint", "Float"].map(function(a) {
        return a + o + "Array";
      });
    }))).filter(function(o) {
      return s[o];
    }), Rs = new Set(He.map(function(o) {
      return s[o];
    })), hr = null;
    function dt(o) {
      return hr = /* @__PURE__ */ new WeakMap(), o = function a(c) {
        ...
        } else if (Rs.has(c.constructor)) u = c;
        else {
          var m, b = _(c);
          for (m in u = b === Object.prototype ? {} : Object.create(b), hr.set(c, u), c) v(c, m) && (u[m] = a(c[m]));
        }
        return u;
      }(o), hr = null, o;
    }
    var Qc = {}.toString;
    function yn(o) {
      return Qc.call(o).slice(8, -1);
    }
    var xn = typeof Symbol < "u" ? Symbol.iterator : "@@iterator", ed = typeof xn == "symbol" ? function(o) {
      var a;
    ...
    var wn = typeof Symbol < "u" ? function(o) {
      ...
      return !1;
    }, _r = ["Unknown", "Constraint", "Data", "TransactionInactive", "ReadOnly", "Version", "NotFound", "InvalidState", "InvalidAccess", "Abort", "Timeout", "QuotaExceeded", "Syntax", "DataClone"], ze = ["Modify", "Bulk", "OpenFailed", "VersionChange", "Schema", "Upgrade", "InvalidTable", "MissingAPI", "NoSuchDatabase", "InvalidArgument", "SubTransaction", "Unsupported", "Internal", "DatabaseClosed", "PrematureCommit", "ForeignAwait"].concat(_r), td = { VersionChanged: "Database version changed by other database connection", DatabaseClosed: "Database has been closed", Abort: "Transaction aborted", TransactionInactive: "Transaction has already completed or failed", MissingAPI: "IndexedDB API missing. Please visit https://tinyurl.com/y2uuvskb" };
    function Ft(o, a) {
...
`);
    ...
    function oi(o, a, c, u) {
      this.failures = a, this.failedKeys = u, this.successCount = c, this.message = $s(o, a);
    }
    function Lt(o, a) {
      this.name = "BulkError", this.failures = Object.keys(a).map(function(c) {
        return a[c];
      }), this.failuresByPos = a, this.message = $s(o, this.failures);
    }
    ee(Ft).from(Error).extend({ toString: function() {
      return this.name + ": " + this.message;
    } }), ee(oi).from(Ft), ee(Lt).from(Ft);
    var Cn = ze.reduce(function(o, a) {
      return o[a] = a + "Error", o;
    }, {}), rd = Ft, j = ze.reduce(function(o, a) {
      var c = a + "Error";
      function u(h, p) {
        this.name = c, h ? typeof h == "string" ? (this.message = "".concat(h).concat(p ? `
 ` + p : ""), this.inner = p || null) : typeof h == "object" && (this.message = "".concat(h.name, " ").concat(h.message), this.inner = h) : (this.message = td[a] || c, this.inner = null);
      }
      return ee(u).from(rd), o[a] = u, o;
    }, {});
    j.Syntax = SyntaxError, j.Type = TypeError, j.Range = RangeError;
    var Ns = _r.reduce(function(o, a) {
      return o[a + "Error"] = j[a], o;
    }, {}), si = ze.reduce(function(o, a) {
    ...
    function id(o, a) {
      return o == null || o === fr ? a : function(c) {
        return a(o(c));
      };
    }
    function ht(o, a) {
    ...
    si.ModifyError = oi, si.DexieError = Ft, si.BulkError = Lt;
    var Me = typeof location < "u" && /^(http|https):\/\/(localhost|127\.0\.0\.1)/.test(location.href);
    function Ds(o) {
      Me = o;
    }
    var pr = {}, Ms = 100, He = typeof Promise > "u" ? [] : function() {
      var o = Promise.resolve();
      if (typeof crypto > "u" || !crypto.subtle) return [o, _(o), o];
      var a = crypto.subtle.digest("SHA-512", new Uint8Array([0]));
      return [a, _(a), o];
    }(), _r = He[0], ze = He[1], He = He[2], ze = ze && ze.then, mr = _r && _r.constructor, An = !!He, gr = function(o, a) {
      br.push([o, a]), ai && (queueMicrotask(cd), ai = !1);
    }, kn = !0, ai = !0, ft = [], li = [], Pn = fr, We = { id: "global", global: !0, ref: 0, unhandleds: [], onunhandled: te, pgp: !1, env: {}, finalize: te }, U = We, br = [], pt = 0, ci = [];
    function V(o) {
        ...
        try {
          h(function(p) {
            if (u._state === null) {
              ...
              }) : (u._state = !0, u._value = p, Ls(u)), m && Vt();
            }
          }, In.bind(null, u));
        } catch (p) {
          In(u, p);
    ...
    var Sn = { get: function() {
      var o = U, a = fi;
      function c(u, h) {
        var p = this, m = !o.global && (o !== U || a !== fi), b = m && !Ye(), C = new V(function(x, k) {
          Tn(p, new Fs(Vs(u, o, m, b), Vs(h, o, m, b), x, k, o));
        });
        return this._consoleTask && (C._consoleTask = this._consoleTask), C;
      }
      return c.prototype = pr, c;
    }, set: function(o) {
      H(this, "then", o && o.prototype === pr ? Sn : { get: function() {
        return o;
      }, set: Sn.set });
    } };
    function Fs(o, a, c, u, h) {
    ...
    function In(o, a) {
      var c, u;
      li.push(a), o._state === null && (c = o._lib && Bt(), a = Pn(a), o._state = !1, o._value = a, u = o, ft.some(function(h) {
    ...
    function Ls(o) {
      ...
      var h = o._PSD;
      --h.ref || h.finalize(), pt === 0 && (++pt, gr(function() {
        --pt == 0 && On();
      }, []));
    }
    function Tn(o, a) {
      if (o._state !== null) {
        ...
        ++a.psd.ref, ++pt, gr(ld, [c, o, a]);
      } else o._listeners.push(a);
    }
    function ld(o, a, c) {
      try {
        var u, h = a._value;
        !a._state && li.length && (li = []), u = Me && a._consoleTask ? a._consoleTask.run(function() {
          return o(h);
        }) : o(h), a._state || li.indexOf(h) !== -1 || function(p) {
          for (var m = ft.length; m; ) if (ft[--m]._value === p._value) return ft.splice(m, 1);
        }(a), c.resolve(u);
      } catch (p) {
        c.reject(p);
      } finally {
    ...
    function Vt() {
      var o, a, c;
      do
        for (; 0 < br.length; ) for (o = br, br = [], c = o.length, a = 0; a < c; ++a) {
          var u = o[a];
          u[0].apply(null, u[1]);
        }
      while (0 < br.length);
    ...
    function On() {
      ...
      for (var a = ci.slice(0), c = a.length; c; ) a[--c]();
    }
    function di(o) {
      return new V(pr, !1, o);
    }
    ...
    z(V.prototype, { then: Sn, _then: function(o, a) {
    ...
    } }), typeof Symbol < "u" && Symbol.toStringTag && H(V.prototype, Symbol.toStringTag, "Dexie.Promise"), We.env = Bs(), z(V, { all: function() {
      var o = Be.apply(null, arguments).map(pi);
      return new V(function(a, c) {
        o.length === 0 && a([]);
        var u = o.length;
        o.forEach(function(h, p) {
          return V.resolve(h).then(function(m) {
            o[p] = m, --u || a(o);
          }, c);
        });
      });
      ...
      return new V(function(c, u) {
        return Ge(function(h, p) {
          var m = U;
          m.unhandleds = [], m.onunhandled = p, m.finalize = ht(function() {
            var b, C = this;
            b = function() {
              C.unhandleds.length === 0 ? h() : p(C.unhandleds[0]);
            }, ci.push(function x() {
              b(), ci.splice(ci.indexOf(x), 1);
            }), ++pt, gr(function() {
              --pt == 0 && On();
            }, []);
          }, m.finalize), o();
    ...
    } }), mr && (mr.allSettled && H(V, "allSettled", function() {
      var o = Be.apply(null, arguments).map(pi);
      return new V(function(a) {
        ...
        o.forEach(function(h, p) {
          return V.resolve(h).then(function(m) {
            return u[p] = { status: "fulfilled", value: m };
          }, function(m) {
            return u[p] = { status: "rejected", reason: m };
          }).then(function() {
            return --c || a(u);
          });
        });
      });
    }), mr.any && typeof AggregateError < "u" && H(V, "any", function() {
      var o = Be.apply(null, arguments).map(pi);
      return new V(function(a, c) {
        ...
        o.forEach(function(p, m) {
          return V.resolve(p).then(function(b) {
            ...
            h[m] = b, --u || c(new AggregateError(h));
          });
        });
      });
    }));
    var pe = { awaits: 0, echoes: 0, id: 0 }, dd = 0, ui = [], hi = 0, fi = 0, ud = 0;
    function Ge(o, a, c, u) {
      var h = U, p = Object.create(h);
      return p.parent = h, p.ref = 0, p.global = !1, p.id = ++ud, We.env, p.env = An ? { Promise: V, PromiseProp: { value: V, configurable: !0, writable: !0 }, all: V.all, race: V.race, allSettled: V.allSettled, any: V.any, resolve: V.resolve, reject: V.reject } : {}, a && f(p, a), ++h.ref, p.finalize = function() {
        --this.parent.ref || this.parent.finalize();
      }, u = _t(p, o, c, u), p.ref === 0 && p.finalize(), u;
    }
    function Ht() {
      return pe.id || (pe.id = ++dd), ++pe.awaits, pe.echoes += Ms, pe.id;
    }
    function Ye() {
      return !!pe.awaits && (--pe.awaits == 0 && (pe.id = 0), pe.echoes = pe.awaits * Ms, !0);
    }
    function pi(o) {
      return pe.echoes && o && o.constructor === mr ? (Ht(), o.then(function(a) {
        return Ye(), a;
      }, function(a) {
        return Ye(), le(a);
      })) : o;
    ...
    function hd() {
      var o = ui[ui.length - 1];
      ui.pop(), Ze(o, !1);
    }
    function Ze(o, a) {
      var c, u = U;
      (a ? !pe.echoes || hi++ && o === U : !hi || --hi && o === U) || queueMicrotask(a ? (function(h) {
        ++fi, pe.echoes && --pe.echoes != 0 || (pe.echoes = pe.awaits = pe.id = 0), ui.push(U), Ze(h, !0);
      }).bind(null, o) : hd), o !== U && (U = o, u === We && (We.env = Bs()), An && (c = We.env.Promise, a = o.env, (u.global || o.global) && (Object.defineProperty(s, "Promise", a.PromiseProp), c.all = a.all, c.race = a.race, c.resolve = a.resolve, c.reject = a.reject, a.allSettled && (c.allSettled = a.allSettled), a.any && (c.any = a.any))));
    }
    function Bs() {
      var o = s.Promise;
    ...
    function zn(o) {
      Promise === mr && pe.echoes === 0 ? hi === 0 ? o() : enqueueNativeMicroTask(o) : setTimeout(o, 0);
    }
    ("" + ze).indexOf("[native code]") === -1 && (Ht = Ye = te);
    var le = V.reject, mt = "￿", Ve = "Invalid key provided. Keys must be of type string, number, Date or Array<string | number | Date>.", Hs = "String expected.", Ut = [], _i = "__dbnames", Rn = "readonly", $n = "readwrite";
    function gt(o, a) {
      return o ? a ? function() {
        return o.apply(this, arguments) && a.apply(this, arguments);
      } : o : a;
    }
    var Us = { type: 3, lower: -1 / 0, lowerOpen: !1, upper: [[]], upperOpen: !1 };
    function mi(o) {
    ...
    function Z(o, a) {
      try {
        ...
        switch (c) {
          ...
          case "binary":
            return function(h, p) {
              for (var m = h.length, b = p.length, C = m < b ? m : b, x = 0; x < C; ++x) if (h[x] !== p[x]) return h[x] < p[x] ? -1 : 1;
              return m === b ? 0 : m < b ? -1 : 1;
            }(Ks(o), Ks(a));
          case "Array":
            return function(h, p) {
              for (var m = h.length, b = p.length, C = m < b ? m : b, x = 0; x < C; ++x) {
                var k = Z(h[x], p[x]);
                if (k !== 0) return k;
              }
              return m === b ? 0 : m < b ? -1 : 1;
    ...
    var Ws = (ne.prototype._trans = function(o, a, c) {
      var u = this._tx || U.trans, h = this.name, p = Me && typeof console < "u" && console.createTask && console.createTask("Dexie: ".concat(o === "readonly" ? "read" : "write", " ").concat(this.name));
      function m(x, k, y) {
      ...
      var b = Bt();
      try {
        var C = u && u.db._novip === this.db._novip ? u === U.trans ? u._promise(o, m, c) : Ge(function() {
          return u._promise(o, m, c);
          ...
          if (k.idbdb && (k._state.openComplete || U.letThrough || k._vip)) {
            ...
            try {
              ...
              return S.name === Cn.InvalidState && k.isOpen() && 0 < --k._state.PR1398_maxLoop ? (console.warn("Dexie: Need to reopen db"), k.close({ disableAutoOpen: !1 }), k.open().then(function() {
                return x(k, y, P, w);
              })) : le(S);
            }
      ...
      if (c && this.db._maxKey !== mt) {
        var m = c.keyPath.slice(0, a.length);
        return this.where(m).equals(m.map(function(x) {
          return o[x];
        }));
      }
      !c && Me && console.warn("The query ".concat(JSON.stringify(o), " on ").concat(this.name, " would benefit from a ") + "compound index [".concat(a.join("+"), "]"));
      ...
      }, [null, null]), m = b[0], b = b[1];
      return m ? this.where(m.name).equals(o[m.keyPath]).filter(b) : c ? this.filter(b) : this.where(a).equals("");
      ...
      (this.schema.mappedClass = o).prototype instanceof js && (function(C, x) {
      ...
      for (var p = /* @__PURE__ */ new Set(), m = o.prototype; m; m = _(m)) Object.getOwnPropertyNames(m).forEach(function(C) {
        return p.add(C);
      });
      function b(C) {
        if (!C) return C;
      ...
      var c = this, u = this.schema.primKey, h = u.auto, p = u.keyPath, m = o;
      return p && h && (m = mi(p)(o)), this._trans("readwrite", function(b) {
        return c.core.mutate({ trans: b, type: "add", keys: a != null ? [a] : null, values: [m] });
      }).then(function(b) {
      ...
      var c = this, u = this.schema.primKey, h = u.auto, p = u.keyPath, m = o;
      return p && h && (m = mi(p)(o)), this._trans("readwrite", function(b) {
        return c.core.mutate({ trans: b, type: "put", values: [m], keys: a != null ? [a] : null });
      }).then(function(b) {
        return b.numFailures ? V.reject(b.failures[0]) : b.lastResult;
      }).then(function(b) {
        if (p) try {
      ...
      return this._trans("readwrite", function(a) {
        return o.core.mutate({ trans: a, type: "deleteRange", range: Us });
      }).then(function(a) {
      ...
      return this._trans("readwrite", function(m) {
        ...
        var C = o.length, x = x && b ? o.map(mi(x)) : o;
        return u.core.mutate({ trans: m, type: "add", keys: h, values: x, wantResults: p }).then(function(A) {
      ...
      return this._trans("readwrite", function(m) {
        ...
        if (h && h.length !== o.length) throw new j.InvalidArgument("Arguments objects and keys must have the same length");
        var C = o.length, x = x && b ? o.map(mi(x)) : o;
        return u.core.mutate({ trans: m, type: "put", keys: h, values: x, wantResults: p }).then(function(A) {
          var y = A.numFailures, P = A.results, w = A.lastResult, A = A.failures;
          if (y === 0) return p ? P : w;
      ...
      var a = this, c = this.core, u = o.map(function(m) {
        return m.key;
      }), h = o.map(function(m) {
        return m.changes;
      }), p = [];
      return this._trans("readwrite", function(m) {
        return c.getMany({ trans: m, keys: u, cache: "clone" }).then(function(b) {
          var C = [], x = [];
          ...
          var k = C.length;
          return c.mutate({ trans: m, type: "put", keys: C, values: x, updates: { keys: u, changeSpecs: h } }).then(function(y) {
      ...
      return this._trans("readwrite", function(u) {
        ...
        var h = m.numFailures, p = m.lastResult, m = m.failures;
        if (h === 0) return p;
        throw new Lt("".concat(a.name, ".bulkDelete(): ").concat(h, " of ").concat(c, " operations failed"), m);
      });
    }, ne);
    function ne() {
    }
    function vr(o) {
      function a(m, b) {
        if (b) {
          ...
          return c[m].subscribe.apply(null, x), o;
        }
    ...
    function bi(o, a, c, u) {
      ...
      if (o.or) {
        ...
        return Promise.all([o.or._iterate(m, c), Ys(Gs(o, u, c), o.algorithm, m, !o.keysOnly && o.valueMapper)]);
      }
      return Ys(Gs(o, u, c), gt(o.algorithm, h), a, !o.keysOnly && o.valueMapper);
    }
    function Ys(o, a, c, u) {
      var h = oe(u ? function(p, m, b) {
        return c(u(p), m, b);
      } : c);
    ...
    var He = Symbol(), xr = (Zs.prototype.execute = function(o) {
      if (this.add !== void 0) {
        var a = this.add;
    ...
    var fd = (J.prototype._read = function(o, a) {
      var c = this._ctx;
      ...
      return bi(this._ctx, o, a, this._ctx.table.core);
      ...
      return this._read(function(c) {
        return bi(a, o, c, a.table.core);
      });
    }, J.prototype.count = function(o) {
      var a = this;
      return this._read(function(c) {
        var u = a._ctx, h = u.table.core;
        if (jt(u, !0)) return h.count({ trans: c, query: { index: gi(u, h.schema), range: u.range } }).then(function(m) {
          return Math.min(m, u.limit);
        });
        var p = 0;
        return bi(u, function() {
          return ++p, !1;
        }, c, h).then(function() {
          return p;
        });
      ...
      function b(C, x) {
        return C = p(C, h), x = p(x, h), C < x ? -m : x < C ? m : 0;
      }
      ...
      return this._read(function(c) {
        ...
        if (u.dir === "next" && jt(u, !0) && 0 < u.limit) {
          var h = u.valueMapper, p = gi(u, u.table.core.schema);
      ...
      if (a.dir === "next" && jt(a, !0) && 0 < a.limit) return this._read(function(u) {
        var h = gi(a, a.table.core.schema);
      ...
      return this._write(function(u) {
        var h, p, m;
        m = typeof o == "function" ? o : (h = l(o), p = h.length, function(E) {
          for (var I = !1, T = 0; T < p; ++T) {
            var O = h[T], R = o[O], N = ge(E, O);
            R instanceof xr ? (Ce(E, O, R.execute(N)), I = !0) : N !== R && (Ce(E, O, R), I = !0);
          }
          return I;
        });
        function b(E, O) {
        ...
        return a.clone().primaryKeys().then(function(E) {
          function I(O) {
            ...
            return C.getMany({ trans: u, keys: E.slice(O, O + R), cache: "immutable" }).then(function(N) {
              for (var F = [], D = [], M = k ? [] : null, L = [], $ = 0; $ < R; ++$) {
                ...
                m.call(K, K.value, K) !== !1 && (K.value == null ? L.push(E[O + $]) : k || Z(y(q), y(K.value)) === 0 ? (D.push(K.value), k && M.push(E[O + $])) : (L.push(E[O + $]), F.push(K.value)));
              }
          ...
          return I(0).then(function() {
            if (0 < w.length) throw new oi("Error modifying one or more objects", w, A, S);
            return E.length;
          });
        });
      });
      ...
      return jt(o) && (o.isPrimKey || a.type === 3) ? this._write(function(c) {
        ...
        return o.table.core.count({ trans: c, query: { index: u, range: h } }).then(function(p) {
          return o.table.core.mutate({ trans: c, type: "deleteRange", range: h }).then(function(m) {
            var b = m.failures;
            if (m.lastResult, m.results, m = m.numFailures, m) throw new oi("Could not delete some values", Object.keys(b).map(function(C) {
              return b[C];
            }), p - m);
            return p - m;
          });
    ...
    function Ie(o, a, c) {
      return o = o instanceof Js ? new o.Collection(o) : o, o._ctx.error = new (c || TypeError)(a), o;
    }
    function qt(o) {
    ...
    function vi(o, a, c, u) {
      ...
      return o._addAlgorithm(function(A, S, E) {
        ...
        for (var O = null, R = w; R < y; ++R) {
          ...
          N === null && O === null ? w = R + 1 : (O === null || 0 < m(O, N)) && (O = N);
        }
    ...
    var Js = (Object.defineProperty(_e.prototype, "Collection", { get: function() {
      ...
      return typeof o != "string" ? Ie(this, Hs) : this.between(o, o + mt, !0, !0);
    }, _e.prototype.startsWithIgnoreCase = function(o) {
      return o === "" ? this.startsWith(o) : vi(this, function(a, c) {
        return a.indexOf(c[0]) === 0;
      }, [o], mt);
    }, _e.prototype.equalsIgnoreCase = function(o) {
      return vi(this, function(a, c) {
        return a === c[0];
      }, [o], "");
    }, _e.prototype.anyOfIgnoreCase = function() {
      var o = Be.apply(Mt, arguments);
      return o.length === 0 ? qt(this) : vi(this, function(a, c) {
      ...
      var h = 0;
      return u._addAlgorithm(function(p, m, b) {
        for (var C = p.key; 0 < c(C, a[h]); ) if (++h === a.length) return m(b), !1;
        return c(C, a[h]) === 0 || (m(function() {
          p.continue(a[h]);
        }), !1);
      }), u;
      ...
      var c = this, u = this._cmp, h = this._ascending, p = this._descending, m = this._min, b = this._max;
    ...
    function Fe(o) {
      return oe(function(a) {
        return wr(a), o(a.target.error), !1;
      });
    }
    function wr(o) {
      o.stopPropagation && o.stopPropagation(), o.preventDefault && o.preventDefault();
    }
    var Cr = "storagemutated", Fn = "x-storagemutated-1", Je = vr(null, Cr), md = (Le.prototype._lock = function() {
    ...
    }, Le.prototype.create = function(o) {
      var a = this;
      ...
      return we(this._completion._state === null), (o = this.idbtrans = o || (this.db.core || c).transaction(this.storeNames, this.mode, { durability: this.chromeTransactionDurability })).onerror = oe(function(h) {
        wr(h), a._reject(o.error);
      }), o.onabort = oe(function(h) {
        wr(h), a.active && a._reject(new j.Abort(o.error)), a.active = !1, a.on("abort").fire(h);
      }), o.oncomplete = oe(function() {
        a.active = !1, a._resolve(), "mutatedParts" in o && Je.storagemutated.fire(o.mutatedParts);
      }), this;
    }, Le.prototype._promise = function(o, a, c) {
      var u = this;
      ...
      if (this._locked()) return new V(function(p, m) {
        u._blockedFuncs.push([function() {
          u._promise(o, a, c).then(p, m);
        }, U]);
      });
      if (c) return Ge(function() {
        var p = new V(function(m, b) {
          u._lock();
          var C = a(m, b, u);
          C && C.then && C.then(m, b);
        });
    ...
    }, Le.prototype.waitFor = function(o) {
      ...
      var h = c._waitingFor;
      return new V(function(p, m) {
        u.then(function(b) {
          return c._waitingQueue.push(oe(p.bind(null, b)));
        }, function(b) {
          return c._waitingQueue.push(oe(m.bind(null, b)));
        }).finally(function() {
    ...
    function Ln(o, a, c, u, h, p, m) {
      return { name: o, keyPath: a, unique: c, multi: u, auto: h, compound: p, src: (c && !m ? "&" : "") + (u ? "*" : "") + (h ? "++" : "") + Qs(a) };
    }
    function Qs(o) {
    ...
    function Bn(o, a, c) {
      return { name: o, primKey: a, indexes: c, mappedClass: null, idxByName: (u = function(h) {
        return [h.name, h];
      }, c.reduce(function(h, p, m) {
        return m = u(p, m), m && (h[m[0]] = m[1]), h;
      }, {})) };
      var u;
    }
    var Er = function(o) {
      try {
        return o.only([[]]), Er = function() {
          return [[]];
        }, [[]];
      } catch {
        return Er = function() {
    ...
    function bd(o, a, C) {
      ...
      function h(P) {
        ...
        return { name: A, schema: P, mutate: function(S) {
          ...
          return new Promise(function(T, O) {
            ...
            }, q = Fe(O), K = 0; K < F; ++K) I[K] != null && ((R = N.get(I[K]))._pos = K, R.onsuccess = $, R.onerror = q, ++M);
            M === 0 && T(D);
          });
        }, get: function(S) {
          ...
          return new Promise(function(E, I) {
            ...
            }, D.onerror = Fe(I)) : (T = 0, O = !N && "openKeyCursor" in L ? L.openKeyCursor($) : L.openCursor($), R = [], O.onsuccess = function(q) {
              var K = O.result;
          ...
          return new Promise(function(N, F) {
            ...
            $.onerror = Fe(F), $.onsuccess = oe(function(q) {
              var K, Y, W, Re, G = $.result;
              G ? (G.___id = ++gd, G.done = !1, K = G.continue.bind(G), Y = (Y = G.continuePrimaryKey) && Y.bind(G), W = G.advance.bind(G), Re = function() {
                ...
                var zi = new Promise(function(Ae, yt) {
                  Ae = oe(Ae), $.onerror = Fe(yt), G.fail = yt, G.stop = function(oo) {
                    G.stop = G.continue = G.continuePrimaryKey = G.advance = Re, Ae(oo);
                  };
                });
                return $.onsuccess = oe(function(Ae) {
                  $.onsuccess = ve, ve();
                }), G.continue = K, G.continuePrimaryKey = Y, G.advance = W, ve(), zi;
              }, N(G)) : N(null);
            }, F);
          });
        }, count: function(S) {
      ...
      var p, m, b, k = (m = C, b = ea((p = o).objectStoreNames), { schema: { name: p.name, tables: b.map(function(P) {
        return m.objectStore(P);
      }).map(function(P) {
        var w = P.keyPath, E = P.autoIncrement, A = d(w), S = {}, E = { name: P.name, primaryKey: { name: null, isPrimaryKey: !0, outbound: w == null, compound: A, keyPath: w, autoIncrement: E, unique: !0, extractKey: Vn(w) }, indexes: ea(P.indexNames).map(function(I) {
          return P.index(I);
        }).map(function(R) {
        ...
        return S[":id"] = E.primaryKey, w != null && (S[Ar(w)] = E.primaryKey), E;
      }) }, hasGetAll: 0 < b.length && "getAll" in m.objectStore(b[0]) && !(typeof navigator < "u" && /Safari/.test(navigator.userAgent) && !/(Chrome\/|Edge\/)/.test(navigator.userAgent) && [].concat(navigator.userAgent.match(/Safari\/(\d*)/))[1] < 604) }), C = k.schema, x = k.hasGetAll, k = C.tables.map(h), y = {};
      return k.forEach(function(P) {
        ...
        return y[P];
      }, MIN_KEY: -1 / 0, MAX_KEY: Er(a), schema: C };
    }
    function vd(o, a, c, u) {
      var h = c.IDBKeyRange;
      return c.indexedDB, { dbcore: (u = bd(a, h, u), o.dbcore.reduce(function(p, m) {
        return m = m.create, r(r({}, p), m(p));
      }, u)) };
    }
    function yi(o, u) {
      var c = u.db, u = vd(o._middlewares, c, o._deps, u);
      ...
      c.forEach(function(h) {
        ...
        a.forEach(function(m) {
          var b = function C(x, k) {
            return se(x, k) || (x = _(x)) && C(x, k);
          }(m, h);
          (!b || "value" in b && b.value === void 0) && (m === o.Transaction.prototype || m instanceof o.Transaction ? H(m, h, { get: function() {
            return this.table(h);
          }, set: function(C) {
    ...
    function xd(o, a, c, u) {
      var h = o._dbSchema;
      c.objectStoreNames.contains("$meta") && !h.$meta && (h.$meta = Bn("$meta", ra("")[0], []), o._storeNames.push("$meta"));
      var p = o._createTransaction("readwrite", o._storeNames, h);
      p.create(c), p._completion.catch(u);
      var m = p._reject.bind(p), b = U.transless || U;
      Ge(function() {
        return U.trans = p, U.transless = b, a !== 0 ? (yi(o, c), x = a, ((C = p).storeNames.includes("$meta") ? C.table("$meta").get("version").then(function(k) {
          return k ?? x;
        }) : V.resolve(x)).then(function(k) {
          return P = k, w = p, A = c, S = [], k = (y = o)._versions, E = y._dbSchema = Ci(0, y.idbdb, A), (k = k.filter(function(I) {
            return I._cfg.version >= P;
          })).length !== 0 ? (k.forEach(function(I) {
            S.push(function() {
              var T = E, O = I._cfg.dbschema;
              Ei(y, T, A), Ei(y, O, A), E = y._dbSchema = O;
              var R = Un(T, O);
              ...
              if (N && I._cfg.version > P) {
                yi(y, A), w._memoizedTables = {};
                var F = Os(O);
                R.del.forEach(function(L) {
                  F[L] = T[L];
                }), Hn(y, [y.Transaction.prototype]), xi(y, [y.Transaction.prototype], l(F), F), w.schema = F;
                var D, M = wn(N);
              ...
              }), Hn(y, [y.Transaction.prototype]), xi(y, [y.Transaction.prototype], y._storeNames, y._dbSchema), w.schema = y._dbSchema;
            }), S.push(function(T) {
          ...
          var y, P, w, A, S, E;
        }).catch(m)) : (l(h).forEach(function(k) {
          jn(c, k, h[k].primKey, h[k].indexes);
        }), yi(o, c), void V.follow(function() {
    ...
    function wd(o, a) {
      ta(o._dbSchema, a), a.db.version % 10 != 0 || a.objectStoreNames.contains("$meta") || a.db.createObjectStore("$meta").add(Math.ceil(a.db.version / 10 - 1), "version");
      var c = Ci(0, o.idbdb, a);
      Ei(o, o._dbSchema, a);
      for (var u = 0, h = Un(c, o._dbSchema).change; u < h.length; u++) {
        var p = function(m) {
          ...
          var b = a.objectStore(m.name);
          m.add.forEach(function(C) {
            Me && console.debug("Dexie upgrade patch: Creating missing index ".concat(m.name, ".").concat(C.src)), wi(b, C);
          });
        }(h[u]);
    ...
    function Un(o, a) {
      ...
      for (c in a) {
        var h = o[c], p = a[c];
        if (h) {
          var m = { name: c, def: p, recreate: !1, del: [], add: [], change: [] };
          if ("" + (h.primKey.keyPath || "") != "" + (p.primKey.keyPath || "") || h.primKey.auto !== p.primKey.auto) m.recreate = !0, u.change.push(m);
          else {
            var b = h.idxByName, C = p.idxByName, x = void 0;
            for (x in b) C[x] || m.del.push(x);
            for (x in C) {
              var k = b[x], y = C[x];
              k ? k.src !== y.src && m.change.push(y) : m.add.push(y);
            }
            (0 < m.del.length || 0 < m.add.length || 0 < m.change.length) && u.change.push(m);
          }
        } else u.add.push([c, p]);
      }
      return u;
    ...
    function ta(o, a) {
      l(o).forEach(function(c) {
        a.db.objectStoreNames.contains(c) || (Me && console.debug("Dexie: Creating missing table", c), jn(a, c, o[c].primKey, o[c].indexes));
      });
    }
    function wi(o, a) {
    ...
    function Ci(o, a, c) {
      ...
      return re(a.objectStoreNames, 0).forEach(function(h) {
        for (var p = c.objectStore(h), m = Ln(Qs(x = p.keyPath), x || "", !0, !1, !!p.autoIncrement, x && typeof x != "string", !0), b = [], C = 0; C < p.indexNames.length; ++C) {
    ...
    function Ei(o, a, c) {
      for (var u = c.db.objectStoreNames, h = 0; h < u.length; ++h) {
        var p = u[h], m = c.objectStore(p);
        o._hasGetAll = "getAll" in m;
        for (var b = 0; b < m.indexNames.length; ++b) {
          var C = m.indexNames[b], x = m.index(C).keyPath, k = typeof x == "string" ? x : "[" + re(x).join("+") + "]";
    ...
    var Cd = (Ai.prototype._parseStoresSpec = function(o, a) {
      l(o).forEach(function(c) {
        if (o[c] !== null) {
          var u = ra(o[c]), h = u.shift();
      ...
      }), a._dbSchema = h, Hn(a, [a._allTables, a, a.Transaction.prototype]), xi(a, [a._allTables, a, a.Transaction.prototype, this._cfg.tables], l(h), h), a._storeNames = l(h), this;
    }, Ai.prototype.upgrade = function(o) {
    ...
    function qn(o, a) {
      var c = o._dbNamesDB;
      return c || (c = o._dbNamesDB = new Ue(_i, { addons: [], indexedDB: o, IDBKeyRange: a })).version(1).stores({ dbnames: "name" }), c.table("dbnames");
    }
    function Kn(o) {
    ...
    function kr(o, a, c) {
      ...
      if (!isNaN(u)) {
        ...
        var h = o.l, u = o.r;
        if (Z(c, o.from) < 0) return h ? kr(h, a, c) : o.l = { from: a, to: c, d: 1, l: null, r: null }, na(o);
        if (0 < Z(a, o.to)) return u ? kr(u, a, c) : o.r = { from: a, to: c, d: 1, l: null, r: null }, na(o);
        Z(a, o.from) < 0 && (o.from = a, o.l = null, o.d = u ? u.d + 1 : 1), 0 < Z(c, o.to) && (o.to = c, o.r = null, o.d = o.l ? o.l.d + 1 : 1), c = !o.r, h && !o.l && Pr(o, h), u && c && Pr(o, u);
      }
    }
    function Pr(o, a) {
      Gn(a) || function c(u, C) {
        var p = C.from, m = C.to, b = C.l, C = C.r;
        kr(u, p, m), b && c(u, b), C && c(u, C);
      }(o, a);
    }
    function ia(o, a) {
      var c = ki(a), u = c.next();
      if (u.done) return !1;
      for (var h = u.value, p = ki(o), m = p.next(h.from), b = m.value; !u.done && !m.done; ) {
        if (Z(b.from, h.to) <= 0 && 0 <= Z(b.to, h.from)) return !0;
        Z(h.from, b.from) < 0 ? h = (u = c.next(b.from)).value : b = (m = p.next(h.from)).value;
      }
      return !1;
    }
    function ki(o) {
    ...
    function na(o) {
      ...
      h && (a = h == "r" ? "l" : "r", c = r({}, o), u = o[h], o.from = u.from, o.to = u.to, o[h] = u[h], c[h] = u[a], (o[a] = c).d = oa(c)), o.d = oa(o);
    }
    function oa(c) {
      var a = c.r, c = c.l;
    ...
    function Pi(o, a) {
      return l(a).forEach(function(c) {
        o[c] ? Pr(o[c], a[c]) : o[c] = function u(h) {
          var p, m, b = {};
          for (p in h) v(h, p) && (m = h[p], b[p] = !m || typeof m != "object" || Rs.has(m.constructor) ? m : u(m));
          return b;
        }(a[c]);
      }), o;
    }
    function Yn(o, a) {
      return o.all || a.all || Object.keys(o).some(function(c) {
        return a[c] && ia(a[c], o[c]);
      });
    }
    z(Ee.prototype, ((ze = { add: function(o) {
      return Pr(this, o), this;
    }, addKey: function(o) {
    ...
    var bt = {}, Zn = {}, Xn = !1;
    function Si(o) {
      Pi(Zn, o), Xn || (Xn = !0, setTimeout(function() {
        Xn = !1, Jn(Zn, !(Zn = {}));
      }, 0));
    }
    function Jn(o, a) {
      ...
      if (o.all) for (var u = 0, h = Object.values(bt); u < h.length; u++) sa(m = h[u], o, c, a);
      else for (var p in o) {
        var m, b = /^idb\:\/\/(.*)\/(.*)\//.exec(p);
        b && (p = b[1], b = b[2], (m = bt["idb://".concat(p, "/").concat(b)]) && sa(m, o, c, a));
      }
    ...
    function sa(o, a, c, u) {
      for (var h = [], p = 0, m = Object.entries(o.queries.query); p < m.length; p++) {
        for (var b = m[p], C = b[0], x = [], k = 0, y = b[1]; k < y.length; k++) {
          var P = y[k];
    ...
    function Ed(o) {
      ...
      function b() {
        return new V(function(P, w) {
          if (m(), !c) throw new j.MissingAPI();
          var A = o.name, S = a.autoSchema || !h ? c.open(A) : c.open(A, h);
          if (!S) throw new j.MissingAPI();
          S.onerror = Fe(w), S.onblocked = oe(o._fireOnBlocked), S.onupgradeneeded = oe(function(E) {
            var I;
            k = S.transaction, a.autoSchema && !o._options.allowEmptyDB ? (S.onerror = wr, k.abort(), S.result.close(), (I = c.deleteDatabase(A)).onsuccess = I.onerror = oe(function() {
              w(new j.NoSuchDatabase("Database ".concat(A, " doesnt exist")));
            })) : (k.onerror = Fe(w), E = E.oldVersion > Math.pow(2, 62) ? 0 : E.oldVersion, y = E < 1, o.idbdb = S.result, p && wd(o, k), xd(o, E / 10, k, w));
            ...
            if (0 < F.length) try {
              ...
              if (a.autoSchema) I = N, T = D, (E = o).verno = I.version / 10, T = E._dbSchema = Ci(0, I, T), E._storeNames = re(I.objectStoreNames, 0), xi(E, [E._allTables], l(T), T);
              else if (Ei(o, o._dbSchema, D), ((R = Un(Ci(0, (R = o).idbdb, D), R._dbSchema)).add.length || R.change.some(function(M) {
                return M.add.length || M.change.length;
              })) && !p) return console.warn("Dexie SchemaDiff: Schema was extended without increasing the number passed to db.version(). Dexie will add missing parts and increment native version number to workaround this."), N.close(), h = N.version + 1, p = !0, P(b());
              yi(o, D);
            } catch {
            }
            Ut.push(o), N.onversionchange = oe(function(M) {
              ...
              o.on("close").fire(M);
            }), y && (R = o._deps, D = A, N = R.indexedDB, R = R.IDBKeyRange, Kn(N) || D === _i || qn(N, R).put({ name: D }).catch(te)), P();
          }, w);
        }).catch(function(P) {
      ...
      return V.race([u, (typeof navigator > "u" ? V.resolve() : !navigator.userAgentData && /Safari\//.test(navigator.userAgent) && !/Chrom(e|ium)\//.test(navigator.userAgent) && indexedDB.databases ? new Promise(function(P) {
        ...
        return m(), a.onReadyBeingFired = [], V.resolve(Wn(function() {
    ...
    var Ad = { stack: "dbcore", name: "VirtualIndexMiddleware", level: 1, create: function(o) {
      return r(r({}, o), { table: function(a) {
        var c = o.table(a), u = c.schema, h = {}, p = [];
        function m(y, P, w) {
          var A = Ar(y), S = h[A] = h[A] || [], E = y == null ? 0 : typeof y == "string" ? 1 : y.length, I = 0 < P, I = r(r({}, w), { name: I ? "".concat(A, "(virtual-from:").concat(w.name, ")") : w.name, lowLevelIndex: w, isVirtual: I, keyTail: P, keyLength: E, extractKey: Vn(y), unique: !I && w.unique });
          return S.push(I), I.isPrimaryKey || p.push(I), 1 < E && m(E === 2 ? y[0] : y.slice(0, E - 1), P + 1, w), S.sort(function(T, O) {
            return T.keyTail - O.keyTail;
          }), I;
        }
        a = m(u.primaryKey.keyPath, 0, u.primaryKey), h[":id"] = [a];
        ...
        function k(y) {
          ...
          return w.isVirtual ? r(r({}, y), { query: { index: w.lowLevelIndex, range: (P = y.query.range, w = w.keyTail, { type: P.type === 1 ? 2 : P.type, lower: Ii(P.lower, P.lowerOpen ? o.MAX_KEY : o.MIN_KEY, w), lowerOpen: !0, upper: Ii(P.upper, P.upperOpen ? o.MIN_KEY : o.MAX_KEY, w), upperOpen: !0 }) } }) : y;
        }
        return r(r({}, c), { schema: r(r({}, u), { primaryKey: a, indexes: p, getIndexByKeyPath: function(y) {
          ...
          function E(I) {
            return Object.create(I, { continue: { value: function(T) {
              T != null ? I.continue(Ii(T, y.reverse ? o.MAX_KEY : o.MIN_KEY, w)) : y.unique ? I.continue(I.key.slice(0, S).concat(y.reverse ? o.MIN_KEY : o.MAX_KEY, w)) : I.continue();
            } }, continuePrimaryKey: { value: function(T, O) {
              I.continuePrimaryKey(Ii(T, o.MAX_KEY, w), O);
    ...
    function eo(o, a, c, u) {
      return c = c || {}, u = u || "", l(o).forEach(function(h) {
        var p, m, b;
        v(a, h) ? (p = o[h], m = a[h], typeof p == "object" && typeof m == "object" && p && m ? (b = yn(p)) !== yn(m) ? c[u + h] = a[h] : b === "Object" ? eo(p, m, c, u + h + ".") : p !== m && (c[u + h] = a[h]) : p !== m && (c[u + h] = a[h])) : c[u + h] = void 0;
    ...
    var kd = { stack: "dbcore", name: "HooksMiddleware", level: 2, create: function(o) {
      return r(r({}, o), { table: function(a) {
        var c = o.table(a), u = c.schema.primaryKey;
        return r(r({}, c), { mutate: function(h) {
          var p = U.trans, m = p.table(a).hook, b = m.deleting, C = m.creating, x = m.updating;
          switch (h.type) {
            case "add":
              if (C.fire === te) break;
    ...
    var Pd = { stack: "dbcore", level: -1, create: function(o) {
      return { table: function(a) {
        var c = o.table(a);
        return r(r({}, c), { getMany: function(u) {
          if (!u.cache) return c.getMany(u);
          var h = aa(u.keys, u.trans._cache, u.cache === "clone");
    ...
    var Sd = { stack: "dbcore", level: 0, name: "Observability", create: function(o) {
      ...
      return r(r({}, o), { transaction: function(u, h, p) {
        ...
        var h = o.table(u), p = h.schema, m = p.primaryKey, y = p.indexes, b = m.extractKey, C = m.outbound, x = m.autoIncrement && y.filter(function(w) {
          return w.compound && w.keyPath.includes(m.keyPath);
        }), k = r(r({}, h), { mutate: function(w) {
          function A($) {
            return $ = "idb://".concat(a, "/").concat(u, "/").concat($), O[$] || (O[$] = new Ee());
          }
          var S, E, I, T = w.trans, O = w.mutatedParts || (w.mutatedParts = {}), R = A(""), N = A(":dels"), F = w.type, L = w.type === "deleteRange" ? [w.range] : w.type === "delete" ? [w.keys] : w.values.length < 50 ? [to(m, w).filter(function($) {
            return $;
          }), w.values] : [], D = L[0], M = L[1], L = w.trans._cache;
          return d(D) ? (R.addKeys(D), (L = F === "delete" || D.length === M.length ? aa(D, L) : null) || N.addKeys(D), (L || M) && (S = A, E = L, I = M, p.indexes.forEach(function($) {
            var q = S($.name || "");
            function K(W) {
    ...
    function ua(o, a, P, u, h, p) {
      if (!P || P.length === 0) return o;
      var m = a.query.index, b = m.multiEntry, C = a.query.range, x = u.schema.primaryKey.extractKey, k = m.extractKey, y = (m.lowLevelIndex || m).extractKey, P = P.reduce(function(w, A) {
        var S = w, E = [];
    ...
    var Od = { stack: "dbcore", level: 0, name: "Cache", create: function(o) {
      var a = o.schema.name;
      return r(r({}, o), { transaction: function(c, u, h) {
        var p, m, b = o.transaction(c, u, h);
        return u === "readwrite" && (m = (p = new AbortController()).signal, h = function(C) {
          return function() {
              ...
              for (var x = /* @__PURE__ */ new Set(), k = 0, y = c; k < y.length; k++) {
                ...
                if (w) {
                  ...
                  if (b._explicit && C && b.mutatedParts) for (var E = 0, I = Object.values(w.queries.query); E < I.length; E++) for (var T = 0, O = (F = I[E]).slice(); T < O.length; T++) Yn((D = O[T]).obsSet, b.mutatedParts) && (ut(F, D), D.subscribers.forEach(function(q) {
                    ...
                    for (var R = 0, N = Object.values(w.queries.query); R < N.length; R++) for (var F, D, M, L = 0, $ = (F = N[R]).slice(); L < $.length; L++) (D = $[L]).res != null && b.mutatedParts && (C && !D.dirty ? (M = Object.isFrozen(D.res), M = ua(D.res, D.req, S, A, D, M), D.dirty ? (ut(F, D), D.subscribers.forEach(function(q) {
                      return x.add(q);
        ...
        }, b.addEventListener("abort", h(!1), { signal: m }), b.addEventListener("error", h(!1), { signal: m }), b.addEventListener("complete", h(!0), { signal: m })), b;
      }, table: function(c) {
        var u = o.table(c), h = u.schema.primaryKey;
        return r(r({}, u), { mutate: function(p) {
          var m = U.trans;
          if (h.outbound || m.db._options.cache === "disabled" || m.explicit) return u.mutate(p);
          var b = bt["idb://".concat(a, "/").concat(c)];
          return b ? (m = u.mutate(p), p.type !== "add" && p.type !== "put" || !(50 <= p.values.length || to(h, p).some(function(C) {
            return C == null;
          })) ? (b.optimisticOps.push(p), p.mutatedParts && Si(p.mutatedParts), m.then(function(C) {
            0 < C.numFailures && (ut(b.optimisticOps, p), (C = da(0, p, C)) && b.optimisticOps.push(C), p.mutatedParts && Si(p.mutatedParts));
          }), m.catch(function() {
            ut(b.optimisticOps, p), p.mutatedParts && Si(p.mutatedParts);
          })) : m.then(function(C) {
            var x = da(0, r(r({}, p), { values: p.values.map(function(w, y) {
            ...
            b.optimisticOps.push(x), queueMicrotask(function() {
              return p.mutatedParts && Si(p.mutatedParts);
            });
          }), m) : u.mutate(p);
        }, query: function(p) {
          if (!la(U, u) || !ca("query", p)) return u.query(p);
          var m = ((x = U.trans) === null || x === void 0 ? void 0 : x.db._options.cache) === "immutable", y = U, b = y.requery, C = y.signal, x = function(A, S, E, I) {
            ...
            switch (E) {
              case "query":
                var R = O.find(function(N) {
                  return N.req.limit === I.limit && N.req.values === I.values && ha(N.req.query.range, I.query.range);
                });
                return R ? [R, !0, T, O] : [O.find(function(N) {
                  return ("limit" in N.req ? N.req.limit : 1 / 0) >= I.limit && (!I.values || N.req.values) && Id(N.req.query.range, I.query.range);
                }), !1, T, O];
              case "count":
                return R = O.find(function(N) {
                  return ha(N.req.query.range, I.query.range);
                }), [R, !!R, T, O];
            }
          ...
          }), k = { obsSet: p.obsSet, promise: y, subscribers: /* @__PURE__ */ new Set(), type: "query", req: p, dirty: !1 }, w ? w.push(k) : (w = [k], (P = P || (bt["idb://".concat(a, "/").concat(c)] = { queries: { query: {}, count: {} }, objs: /* @__PURE__ */ new Map(), optimisticOps: [], unsignaledParts: {} })).queries.query[p.query.index.name || ""] = w)), Td(k, w, b, C), k.promise.then(function(A) {
            return { result: ua(A.result, p, P == null ? void 0 : P.optimisticOps, u, k, m) };
          });
        } });
      } });
    } };
    ...
    var Ue = (ce.prototype.version = function(o) {
      ...
      return c || (c = new this.Version(o), a.push(c), a.sort(yd), c.stores({}), this._state.autoSchema = !1, c);
      ...
      return h && this.unuse({ stack: a, name: h }), o = this._middlewares[a] || (this._middlewares[a] = []), o.push({ stack: a, create: c, level: u ?? 10, name: h }), o.sort(function(p, m) {
      ...
      return new V(function(h, p) {
        function m() {
          ...
          b.onsuccess = oe(function() {
            var C, x, k;
            C = a._deps, x = a.name, k = C.indexedDB, C = C.IDBKeyRange, Kn(k) || x === _i || qn(k, C).delete(x).catch(te), h();
          }), b.onerror = Fe(p), b.onblocked = a._fireOnBlocked;
        }
        if (c) throw new j.InvalidArgument("Invalid closeOptions argument to db.delete()");
        u.isBeingOpened ? u.dbReadyPromise.then(m) : m();
      });
      ...
      var p, m, b = o.indexOf("?") !== -1;
      o = o.replace("!", "").replace("?", "");
      try {
        if (m = a.map(function(x) {
      ...
      var C = (function x(k, y, P, w, A) {
        return V.resolve().then(function() {
          ...
          if (E.explicit = !0, S = { trans: E, transless: S }, w) E.idbtrans = w.idbtrans;
            ...
            return O.name === Cn.InvalidState && k.isOpen() && 0 < --k._state.PR1398_maxLoop ? (console.warn("Dexie: Need to reopen db"), k.close({ disableAutoOpen: !1 }), k.open().then(function() {
    ...
    function ce(o, a) {
      ...
      var h, p, m, b, C, x = { dbOpenError: null, isBeingOpened: !1, onReadyBeingFired: null, openComplete: !1, dbReadyResolve: te, dbReadyPromise: null, cancelOpen: te, openCanceller: null, autoSchema: !0, PR1398_maxLoop: 3, autoOpen: a.autoOpen };
      x.dbReadyPromise = new V(function(y) {
        x.dbReadyResolve = y;
      }), x.openCanceller = new V(function(y, P) {
        x.cancelOpen = P;
      }), this._state = x, this.name = o, this.on = vr(this, "populate", "blocked", "versionchange", "close", { ready: [En, te] }), this.on.ready.subscribe = Oe(this.on.ready.subscribe, function(y) {
        return function(P, w) {
          ce.vip(function() {
            var A, S = c._state;
      ...
      }), this.Collection = (h = this, yr(fd.prototype, function(I, E) {
        this.db = h;
        var w = Us, A = null;
        if (E) try {
          w = E();
        ...
        this._ctx = { table: E, index: S.index, isPrimKey: !S.index || E.schema.primKey.keyPath && S.index === E.schema.primKey.name, range: w, keysOnly: !1, dir: "next", unique: "", algorithm: null, filter: null, replayFilter: null, justLimit: !0, isMatch: null, offset: 0, limit: 1 / 0, error: A, or: S.or, valueMapper: I !== fr ? I : null };
      })), this.Table = (p = this, yr(Ws.prototype, function(y, P, w) {
        this.db = p, this._tx = w, this.name = y, this.schema = P, this.hook = p._allTables[y] ? p._allTables[y].hook : vr(null, { creating: [nd, te], reading: [id, fr], updating: [sd, te], deleting: [od, te] });
      })), this.Transaction = (m = this, yr(md.prototype, function(y, P, w, A, S) {
        var E = this;
        this.db = m, this.mode = y, this.storeNames = P, this.schema = w, this.chromeTransactionDurability = A, this.idbtrans = null, this.on = vr(this, "complete", "error", "abort"), this.parent = S || null, this.active = !0, this._reculock = 0, this._blockedFuncs = [], this._resolve = null, this._reject = null, this._waitingFor = null, this._waitingQueue = null, this._spinCount = 0, this._completion = new V(function(I, T) {
      ...
      })), this.Version = (b = this, yr(Cd.prototype, function(y) {
        this.db = b, this._cfg = { version: y, storesSource: null, dbschema: {}, tables: {}, contentUpgrade: null };
      })), this.WhereClause = (C = this, yr(Js.prototype, function(y, P, w) {
        ...
        0 < y.newVersion ? console.warn("Another connection wants to upgrade database '".concat(c.name, "'. Closing db now to resume the upgrade.")) : console.warn("Another connection wants to delete database '".concat(c.name, "'. Closing db now to resume the delete request.")), c.close({ disableAutoOpen: !1 });
      }), this.on("blocked", function(y) {
        !y.newVersion || y.newVersion < y.oldVersion ? console.warn("Dexie.delete('".concat(c.name, "') was blocked")) : console.warn("Upgrade '".concat(c.name, "' blocked by other connection holding version ").concat(y.oldVersion / 10));
      }), this._maxKey = Er(a.IDBKeyRange), this._createTransaction = function(y, P, w, A) {
      ...
      }, this.use(Pd), this.use(Od), this.use(Sd), this.use(Ad), this.use(kd);
      var k = new Proxy(this, { get: function(y, P, w) {
        if (P === "_vip") return !0;
        if (P === "table") return function(S) {
          return Ti(c.table(S), k);
        };
        var A = Reflect.get(y, P, w);
        return A instanceof Ws ? Ti(A, k) : P === "tables" ? A.map(function(S) {
          return Ti(S, k);
        }) : P === "_createTransaction" ? function() {
          return Ti(A.apply(this, arguments), k);
        } : A;
      } });
    ...
    var Oi, ze = typeof Symbol < "u" && "observable" in Symbol ? Symbol.observable : "@@observable", zd = (io.prototype.subscribe = function(o, a, c) {
    ...
    try {
      Oi = { indexedDB: s.indexedDB || s.mozIndexedDB || s.webkitIndexedDB || s.msIndexedDB, IDBKeyRange: s.IDBKeyRange || s.webkitIDBKeyRange };
    } catch {
      Oi = { indexedDB: null, IDBKeyRange: null };
    }
    function fa(o) {
      var a, c = !1, u = new zd(function(h) {
        var p = wn(o), m, b = !1, C = {}, x = {}, k = { get closed() {
          return b;
        }, unsubscribe: function() {
          b || (b = !0, m && m.abort(), y && Je.storagemutated.unsubscribe(w));
        } };
        h.start && h.start(k);
        var y = !1, P = function() {
          return zn(A);
          ...
          var S, E, I;
          !b && Oi.indexedDB && (C = {}, S = {}, m && m.abort(), m = new AbortController(), I = function(T) {
            var O = Bt();
            try {
              p && Ht();
              var R = Ge(o, T);
          ...
          }(E = { subscr: S, signal: m.signal, requery: P, querier: o, trans: null }), Promise.resolve(I).then(function(T) {
            c = !0, a = T, b || E.signal.aborted || (C = {}, function(O) {
              for (var R in O) if (v(O, R)) return;
              return 1;
            }(x = S) || y || (Je(Cr, w), y = !0), zn(function() {
    ...
    z(vt, r(r({}, si), { delete: function(o) {
      ...
      Ds(o);
    } }, derive: ee, extend: f, props: z, override: Oe, Events: vr, on: Je, liveQuery: fa, extendObservabilitySet: Pi, getByKeyPath: ge, setByKeyPath: Ce, delByKeyPath: function(o, a) {
      typeof a == "string" ? Ce(o, a, void 0) : "length" in a && [].map.call(a, function(c) {
        Ce(o, c, void 0);
      });
    }, shallowClone: Os, deepClone: dt, getObjectDiff: eo, cmp: Z, asap: ue, minKey: -1 / 0, addons: [], connections: Ut, errnames: Cn, dependencies: Oi, cache: bt, semVer: "4.0.8", version: "4.0.8".split(".").map(function(o) {
      return parseInt(o);
    }).reduce(function(o, a, c) {
      return o + a / Math.pow(10, 2 * c);
    }) })), vt.maxKey = Er(vt.dependencies.IDBKeyRange), typeof dispatchEvent < "u" && typeof addEventListener < "u" && (Je(Cr, function(o) {
      Qe || (o = new CustomEvent(Fn, { detail: o }), Qe = !0, dispatchEvent(o), Qe = !1);
    }), addEventListener(Fn, function(o) {
      o = o.detail, Qe || no(o);
    }));
    var Kt, Qe = !1, pa = function() {
    };
    return typeof BroadcastChannel < "u" && ((pa = function() {
      (Kt = new BroadcastChannel(Fn)).onmessage = function(o) {
        return o.data && no(o.data);
      };
    })(), typeof Kt.unref == "function" && Kt.unref(), Je(Cr, function(o) {
      Qe || Kt.postMessage(o);
    })), typeof addEventListener < "u" && (addEventListener("pagehide", function(o) {
      if (!Ue.disableBfCache && o.persisted) {
        Me && console.debug("Dexie: handling persisted pagehide"), Kt != null && Kt.close();
        for (var a = 0, c = Ut; a < c.length; a++) c[a].close({ disableAutoOpen: !1 });
      }
    }), addEventListener("pageshow", function(o) {
      !Ue.disableBfCache && o.persisted && (Me && console.debug("Dexie: handling persisted pageshow"), pa(), no({ all: new Ee(-1 / 0, [[]]) }));
    })), V.rejectionMapper = function(o, a) {
      return !o || o instanceof Ft || o instanceof TypeError || o instanceof SyntaxError || !o.name || !Ns[o.name] ? o : (a = new Ns[o.name](a || o.message, o), "stack" in o && H(a, "stack", { get: function() {
        return this.inner.stack;
      } }), a);
    }, Ds(Me), r(Ue, Object.freeze({ __proto__: null, Dexie: Ue, liveQuery: fa, Entity: js, cmp: Z, PropModSymbol: He, PropModification: xr, replacePrefix: function(o, a) {
      return new xr({ replacePrefix: [o, a] });
    }, add: function(o) {
      return new xr({ add: o });
    }, remove: function(o) {
      return new xr({ remove: o });
    }, default: Ue, RangeSet: Ee, mergeRanges: Pr, rangesOverlap: ia }), { default: Ue }), Ue;
  });
})(Kc);
var Q_ = Kc.exports;
const Xo = /* @__PURE__ */ J_(Q_), vl = Symbol.for("Dexie"), Jo = globalThis[vl] || (globalThis[vl] = Xo);
if (Xo.semVer !== Jo.semVer)
  throw new Error(`Two different versions of Dexie loaded in the same app: ${Xo.semVer} and ${Jo.semVer}`);
class em {
  constructor(t) {
    this.apiContext = void 0, this.db = void 0, this.hasRefreshedFavourites = !1, this.hasRefreshedAll = !1, this.localCache = /* @__PURE__ */ new Map(), this.apiContext = t, this.db = this.initDb();
  }
  initDb() {
  ...
  async refreshFavourites() {
    ...
    if (!this.hasRefreshedFavourites) {
      ...
      if (r && r.length > 0) {
        let i = await ((t = this.db) == null ? void 0 : t.kioskTimeZones.where("favourite").equals(1).delete());
        console.log(`Deleted ${i} favourite time zones`);
        const s = r.map((d) => ({
          id: d.id,
          tz_IANA: d.tz_IANA,
          tz_long: d.tz_long,
          deprecated: d.deprecated ? 1 : 0,
          version: d.version,
          favourite: 1
        }));
        let l = await ((e = this.db) == null ? void 0 : e.kioskTimeZones.bulkAdd(s));
        return console.log(`Added ${l} new favourite time zones`), this.hasRefreshedFavourites = !0, s;
      }
    }
    return [];
  }
  async fetchFavouriteTimeZones() {
    var t;
    return await ((t = this.apiContext) == null ? void 0 : t.fetchFromApi("", "favouritetimezones", {
      method: "GET",
  ...
  async fetchAllTimeZones(t = 0) {
    ...
    return e.append("include_deprecated", "true"), t > 0 && e.append("newer_than", `${t}`), await ((r = this.apiContext) == null ? void 0 : r.fetchFromApi("", "timezones", {
      method: "GET",
      caller: "app.fetchFavouriteTimeZones"
    }, "v1", e).then((i) => (console.log("time zone information fetched"), i)).catch((i) => (console.log(`time zone information failed: ${i}`), [])));
  }
  ...
  async getTimeZoneByIndex(t, e = !1) {
    if (!this.db)
      return;
    await this.refreshAllTimeZones(e);
    let r = await this.db.kioskTimeZones.where("id").equals(t).toArray();
   ...
   */
  async cacheLocally(t, e = !1) {
    if (!this.db || typeof t != "number")
      return;
    let r = this.localCache.get(t);
    if (r)
      return r;
    if (r = await this.getTimeZoneByIndex(t), !r) {
      if (!e)
        return;
      await this.refreshAllTimeZones(!1), r = await this.getTimeZoneByIndex(t);
    }
    return r && (console.log("Cached TimeZone", r), this.localCache.set(t, r)), this.localCache.get(t);
  }
  /**
   ...
   */
  getTimeZoneInfoFromLocalCache(t) {
    if (typeof t == "string" && (t = parseInt(t)), !!t)
      return this.localCache.get(t);
  }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Gc = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, am = (n) => (...t) => ({ _$litDirective$: n, values: t });
class lm {
  constructor(t) {
  }
  get _$AU() {
...
const jr = (n, t) => {
  ...
  for (const i of e) (r = i._$AO) == null || r.call(i, t, !1), jr(i, t);
  return !0;
}, cn = (n) => {
  let t, e;
  do {
...
function dm(n) {
  this._$AN !== void 0 ? (cn(this), this._$AM = n, Yc(this)) : this._$AM = n;
}
function um(n, t = !1, e = 0) {
  const r = this._$AH, i = this._$AN;
  if (i !== void 0 && i.size !== 0) if (t) if (Array.isArray(r)) for (let s = e; s < r.length; s++) jr(r[s], !1), cn(r[s]);
  else r != null && (jr(r, !1), cn(r));
  else jr(this, n);
}
const hm = (n) => {
  n.type == Gc.CHILD && (n._$AP ?? (n._$AP = um), n._$AQ ?? (n._$AQ = dm));
};
class fm extends lm {
  constructor() {
  ...
  _$AT(t, e, r) {
    super._$AT(t, e, r), Yc(this), this.isConnected = t._$AU;
  }
  _$AO(t, e = !0) {
    var r, i;
    t !== this.isConnected && (this.isConnected = t, t ? (r = this.reconnected) == null || r.call(this) : (i = this.disconnected) == null || i.call(this)), e && (jr(this, t), cn(this));
  }
  setValue(t) {
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
const yl = Symbol("valueNotInitialized");
class pm extends fm {
  constructor(t) {
    if (super(t), t.type !== Gc.ELEMENT)
      throw new Error(`\`${this.constructor.name}\` must be bound to an element.`);
    this.previousValue = yl;
  }
  /** @override */
  render(t, e) {
    return de;
  ...
  /** @override */
  update(t, [e, r]) {
    return this.hasChanged(r) && (this.host = t.options && t.options.host, this.element = t.element, this.renderer = e, this.previousValue === yl ? this.addRenderer() : this.runRenderer(), this.previousValue = Array.isArray(r) ? [...r] : r), de;
  }
  /** @override */
  reconnected() {
    this.addRenderer();
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
const xl = Symbol("contentUpdateDebouncer");
/**
 * @license
 * Copyright (c) 2017 - 2024 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
const gm = am(mm);
var bm = Object.defineProperty, vm = Object.getOwnPropertyDescriptor, ym = Object.getPrototypeOf, xm = Reflect.get, Zc = (n) => {
  throw TypeError(n);
}, De = (n, t, e, r) => {
  for (var i = r > 1 ? void 0 : r ? vm(t, e) : t, s = n.length - 1, l; s >= 0; s--)
    (l = n[s]) && (i = (r ? l(t, e, i) : l(i)) || i);
  return r && i && bm(t, e, i), i;
}, Xc = (n, t, e) => t.has(n) || Zc("Cannot " + e), Fi = (n, t, e) => (Xc(n, t, "read from private field"), e ? e.call(n) : t.get(n)), Li = (n, t, e) => t.has(n) ? Zc("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(n) : t.set(n, e), Bi = (n, t, e, r) => (Xc(n, t, "write to private field"), t.set(n, e), e), wm = (n, t, e) => xm(ym(n), e, t), qi, Ki, Wi, Gi;
let xe = class extends vn {
  constructor() {
    super(), this.constants = {}, Li(this, qi, []), Li(this, Ki, []), this.searchIdentifier = "", this.heading = "select archaeological entity", this.identifierColumnTitle = "entity", this.initialRecordType = "unit", Li(this, Wi, []), Li(this, Gi, {}), this.recordTypeFilter = [], this.cellRenderer = (n) => {
      const t = Z_(this.recordTypeAliases, n.record_type);
      return Lr`
            <div>
                ${t}
            </div>`;
  ...
  fetchIdentifiers() {
    this.apiContext.fetchFromApi(
      ...
      this.identifiers = n.identifiers, console.log("identifier information fetched", this.identifiers);
    }).catch((n) => {
      this.showProgress = !1, console.log("fetching identifier information failed"), X_(this, n, "loadConstants");
    });
  }
  prepareIdentifiers() {
    console.log("prepare identifiers"), this.recordTypeFilter.length > 0 ? this._identifiers = this.identifiers.filter((n) => this.recordTypeFilter.includes(n.record_type.toLowerCase())) : this._identifiers = this.identifiers;
  }
  filterIdentifiers() {
  ...
  renderGrid() {
    return Lr`
            <vaadin-grid id="grid" class="selection-grid"
                ...
                <vaadin-grid-column header="type" ${gm(this.cellRenderer, [])}></vaadin-grid-column>
            </vaadin-grid>
        `;
  }
  apiRender() {
...
const Cm = '*{padding:0;margin:0;border:0px;-webkit-user-select:none;user-select:none}p,div{-webkit-user-select:text;user-select:text}select{-webkit-user-select:none;user-select:none}.col-bg-body-lighter{background-color:var(--col-bg-body-lighter)}.col-bg-body{background-color:var(--col-bg-body)}.col-bg-body-darker{background-color:var(--col-bg-body-darker)}.col-bg-1-lighter{background-color:var(--col-bg-1-lighter)}.col-bg-1{background-color:var(--col-bg-1)}.col-bg-1-darker{background-color:var(--col-bg-1-darker)}.col-bg-1-input{background-color:var(--col-bg-1-input)}.col-primary-bg-1{background-color:var(--col-primary-bg-1)}.col-accent-bg-1{background-color:var(--col-accent-bg-1)}.col-success-bg-1{background-color:var(--col-success-bg-1)}.col-warning-bg-1{background-color:var(--col-warning-bg-1)}.col-error-bg-1{background-color:var(--col-error-bg-1)}.col-bg-2-lighter{background-color:var(--col-bg-2-lighter)}.col-bg-2{background-color:var(--col-bg-2)}.col-bg-2-darker{background-color:var(--col-bg-2-darker)}.col-bg-2-button{background-color:var(--col-bg-2-button)}.col-bg-2-input{background-color:var(--col-bg-2-input)}.col-primary-bg-2{background-color:var(--col-primary-bg-2)}.col-accent-bg-2{background-color:var(--col-accent-bg-2)}.col-success-bg-2{background-color:var(--col-success-bg-2)}.col-warning-bg-2{background-color:var(--col-warning-bg-2)}.col-error-bg-2{background-color:var(--col-error-bg-2)}.col-bg-3-lighter{background-color:var(--col-bg-3-lighter)}.col-bg-3{background-color:var(--col-bg-3)}.col-bg-3-darker{background-color:var(--col-bg-3-darker)}.col-bg-3-button{background-color:var(--col-bg-3-button)}.col-bg-3-input{background-color:var(--col-bg-3-input)}.col-primary-bg-3{background-color:var(--col-primary-bg-3)}.col-accent-bg-3{background-color:var(--col-accent-bg-3)}.col-success-bg-3{background-color:var(--col-success-bg-3)}.col-warning-bg-3{background-color:var(--col-warning-bg-3)}.col-error-bg-3{background-color:var(--col-error-bg-3)}.col-bg-ack-lighter{background-color:var(--col-bg-ack-lighter)}.col-bg-ack{background-color:var(--col-bg-ack)}.col-bg-ack-darker{background-color:var(--col-bg-ack-darker)}.col-primary-bg-ack{background-color:var(--col-primary-bg-ack)}.col-accent-bg-ack{background-color:var(--col-accent-bg-ack)}.col-bg-att-lighter{background-color:var(--col-bg-att-lighter)}.col-bg-att{background-color:var(--col-bg-att)}.col-bg-att-darker{background-color:var(--col-bg-att-darker)}.col-primary-bg-att{background-color:var(--col-primary-bg-att)}.col-accent-bg-att{background-color:var(--col-accent-bg-att)}.col-bg-alert-lighter{background-color:var(--col-bg-alert-lighter)}.col-bg-alert{background-color:var(--col-bg-alert)}.col-bg-alert-darker{background-color:var(--col-bg-alert-darker)}.col-primary-bg-alert{background-color:var(--col-primary-bg-alert)}.col-accent-bg-alert{background-color:var(--col-accent-bg-alert)}.col-bg-btn-lighter{background-color:var(--col-bg-btn-lighter)}.col-bg-btn{background-color:var(--col-bg-btn)}.col-bg-btn-darker{background-color:var(--col-bg-btn-darker)}.col-primary-bg-btn{background-color:var(--col-primary-bg-btn)}.col-accent-bg-btn{background-color:var(--col-accent-bg-btn)}.pattern-diagonal-stripes-sm{background:repeating-linear-gradient(45deg,transparent,transparent 10px,currentColor 10px,currentColor 20px)}.pattern-dots-lg{background-image:radial-gradient(currentColor 1.5px,transparent 1.5px);background-size:15px 15px}.pattern-dots-md{background-image:radial-gradient(currentColor 1px,transparent 1px);background-size:8px 8px}.pattern-dots-medium-dense{background-image:radial-gradient(currentColor .5px,transparent .5px);background-size:3px 3px}.pattern-dots-sm{background-image:radial-gradient(currentColor .5px,transparent .5px);background-size:5px 5px}.pattern-cross-dots-md,.imagelist-background{background-image:radial-gradient(currentColor .7px,transparent 1px),radial-gradient(currentColor .7px,transparent 1px);background-size:6.5px 6.5px;background-position:0 0,3.5px 3.5px}.imagelist-background{background-color:#fff9;background-blend-mode:overlay}label{font-family:var(--monospace-font);font-size:.9em}input,select{-webkit-user-select:text;-moz-user-select:text;-ms-user-select:text;box-sizing:border-box;border-radius:0;user-select:text;font-family:var(--standard-text-font);background-color:var(--col-bg-1-input);border:none;color:var(--col-primary-bg-1);padding:2px;margin-bottom:2px;outline:none}textarea{outline:none}input:not([type=radio],[type=checkbox]),select,textarea{width:100%}input:not([type=radio],[type=checkbox]):focus,select:focus,textarea:focus{margin-bottom:0;border-bottom:2px solid rgb(0,0,0)}h1{font-size:var(--font-size-h1)}h2{font-size:var(--font-size-h2)}h3{font-size:var(--font-size-h3)}h4{font-size:var(--font-size-h4)}small,.font-small{font-size:var(--font-size-small)}button{width:60px;height:60px;border-radius:35px;border-style:solid;border-width:2px;background-color:var(--col-bg-btn);color:var(--col-primary-bg-btn);border-color:var(--col-bg-btn-darker);font-family:var(--headline-text-font);font-size:var(--font-size-h4);font-weight:700}button:hover,button:focus{outline:none;background-color:var(--col-bg-btn-lighter)}button:active{padding-top:3px;color:var(--col-primary-bg-btn);background-color:var(--col-bg-btn-darker);border-color:var(--col-bg-btn-darker)}.kiosk-btn-128{width:128px;height:128px}.kiosk-btn-32{width:32px;height:32px}.kiosk-dropdown-btn{box-sizing:content-box;border-radius:0;background-color:var(--col-bg-btn);border-color:var(--col-bg-btn-darker);color:var(--col-primary-bg-btn);height:30px;width:30px}.kiosk-dropdown-btn .drop-down-btn{float:left}.kiosk-dropdown-btn .caret{color:var(--col-primary-bg-btn);display:inline-block;width:0;height:0;margin-left:2px;vertical-align:middle;border-color:var(--col-primary-bg-btn);border-top:4px solid;border-right:4px solid transparent;border-left:4px solid transparent}button:disabled{opacity:.3}.modal-round-button,.modal-delete,.modal-close,.modal-cancel,.modal-back,.modal-next,.modal-ok,.modal-button{box-sizing:border-box;margin-left:25px;background-image:none;display:inline-block;font-style:normal;font-variant:normal;text-rendering:auto;-webkit-font-smoothing:antialiased;font-family:"Font Awesome 6 Free";font-weight:900;font-size:24px;line-height:24px;vertical-align:center;text-align:center}.modal-ok:after{content:var(--icon-bt-ok)}.modal-next:after{padding-left:2px;content:var(--icon-bt-next)}.modal-back:after{padding-right:2px;content:var(--icon-bt-back)}.modal-cancel:after{content:var(--icon-bt-cancel)}.modal-close:before{content:var(--icon-bt-close)}.modal-delete{background-color:var(--col-bg-alert);color:var(--col-primary-bg-alert)}.modal-delete:before{content:var(--icon-bt-trash)}.modal-delete:hover,.modal-delete:focus{border-color:var(--col-bg-alert);background-color:var(--col-bg-alert-lighter);background-size:75%}.modal-delete:active{border-color:var(--col-bg-alert);background-color:var(--col-bg-alert-darker);color:var(--col-primary-bg-alert)}.kiosk-rounded{border-radius:15px}.kiosk-shaded{box-shadow:2px 2px 10px #2e380394}.kiosk-margin-bottom{margin-bottom:1em}.flex-line-break{width:100%;height:0px}.kiosk-align-flex-end{align-items:flex-end}.kiosk-align-flex-start{align-items:flex-start}.full-background-bg-1{background:linear-gradient(to right bottom,var(--col-bg-1-darker),var(--col-bg-1-lighter));height:100%;width:100%}.small-list-button i{border-radius:25px;box-shadow:2px 2px 5px #2e380394}.small-list-button:hover{color:var(--col-bg-att)}.small-list-button:hover i{box-shadow:2px 2px 5px #2e380394}.small-list-button:active,.small-list-button:focus{color:var(--col-bg-ack);transform:translateY(5px)}.small-list-button:active i,.small-list-button:focus i{box-shadow:none}.dialog-radio-div{display:flex;flex-direction:row}.dialog-radio-div input[type=radio]{margin-right:.5em}.fa,.fas{font-family:"Font Awesome 6 Free";font-weight:900;font-style:normal}.fa-trash:before{content:""}.fa-view-grid:before{content:""}.fa-reload:before{content:""}.fa-view-list:before{content:""}.fa-camera:before{content:""}.fa-view-image:before{content:""}.fa-check:before{content:""}.fa-bug:before{content:""}.fa-lightbulb:before{content:""}.fa-query:before{content:""}.fa-footsteps{transform:rotate(270deg)}.fa-footsteps:before{content:""}i{font-family:"Font Awesome 6 Free";font-style:normal;font-variant:normal;text-rendering:auto;-webkit-font-smoothing:antialiased;font-weight:900;font-size:.9em}div,p{font-family:var(--standard-text-font)}:host{--lumo-font-size-s: $font-size-standard;--lumo-font-family: $standard-text;--lumo-size-m: $font-size-standard;--lumo-contrast-10pct: rgba(0,0,0,0);--lumo-contrast-60pct: var(--col-accent-bg-1);--lumo-text-field-size: 1em;--lumo-font-size: var(--font-size-standard);--lumo-border-radius-l: 0;--lumo-border-radius-m: 0;--lumo-border-radius-s: 0}vaadin-combo-box{margin-left:calc(-1 * (.375em + var(--lumo-border-radius-m) / 4 - 1px));margin-right:calc(-1 * (.375em + var(--lumo-border-radius-m) / 4 - 1px));padding-top:0}vaadin-combo-box>input{--_lumo-text-field-overflow-mask-image: white;--lumo-text-field-size: 22px;background-color:#fff;max-height:var(--tz-combobox-max-height, 40);padding:var(--tz-combobox-horizontal-padding, 5px) var(--tz-combobox-vertical-padding, 5px)}vaadin-combo-box>input:disabled{background-color:var(--col-bg-1-lighter);--lumo-disabled-text-color: $col-primary-bg-1}vaadin-combo-box{font-family:var(--standard-text-font);font-size:var(--font-size-standard, 1rem);color:var(--col-primary-bg-1);background-color:var(--col-bg-2);width:100%;padding:0}vaadin-combo-box input:disabled,vaadin-combo-box textarea:disabled{background-color:var(--col-bg-1-lighter);color:var(--col-primary-bg-1);-webkit-text-fill-color:currentcolor;opacity:1}vaadin-combo-box::part(input-field){padding:0}';
var Em = Object.defineProperty, Am = Object.getOwnPropertyDescriptor, km = Object.getPrototypeOf, Pm = Reflect.get, ur = (n, t, e, r) => {
  for (var i = r > 1 ? void 0 : r ? Am(t, e) : t, s = n.length - 1, l; s >= 0; s--)
    (l = n[s]) && (i = (r ? l(t, e, i) : l(i)) || i);
  return r && i && Em(t, e, i), i;
}, Sm = (n, t, e) => Pm(km(n), e, t);
let $e = class extends vn {
  // @property()
  ...
  // }
  apiConnected() {
    console.log("fetching time zone information"), this.kioskTimeZones = new em(this.apiContext), this.fetchFavouriteTimeZones();
  }
  fetchFavouriteTimeZones() {
    this.kioskTimeZones && this.kioskTimeZones.getFavouriteTimeZones(!1, !1).then((n) => {
      console.log(`about to add ${n.length} favourites`), this.addTimeZones(n, !0), this.kioskTimeZones && this.kioskTimeZones.getAllTimeZones(this.includeDeprecated).then((t) => {
  ...
  addTimeZones(n, t = !1) {
    ...
    console.log(`kiosktzcombobox: added ${e.length} favourite timezones`), t || (e.push({ label: "------", value: -1 }), e.push(...n.filter((r) => r.favourite != 1).map((r) => ({ label: r.tz_long, value: r.id }))), console.log(`now we have ${e.length} overall timezones`)), this.timeZones = e;
  }
  timeZoneChanged(n) {
    const t = n.target;
    console.log(t.selectedItem), t.selectedItem && t.selectedItem.value > -1 ? (this.value = t.selectedItem.value, this.text = t.selectedItem.label) : (this.value = null, this.text = "", this.requestUpdate("value", -1)), n.preventDefault();
    const e = new CustomEvent("change");
    this.dispatchEvent(e);
  }
  onKeyUp(n) {
    (n.key === "Escape" || n.key === "Enter") && n.stopPropagation();
  }
  apiRender() {
    return Lr`
...
ur([
  Fc()
], $e.prototype, "timeZones", 2);
ur([
  ke({ type: Number, reflect: !0 })
], $e.prototype, "value", 2);
ur([
  ke({ type: String, reflect: !0 })
], $e.prototype, "text", 2);
ur([
  ke({ attribute: !0, type: Boolean })
], $e.prototype, "disabled", 2);
ur([
  ke({ attribute: !0, type: Boolean })
], $e.prototype, "includeDeprecated", 2);
$e = ur([
