...
export async function fetchFromApi(apiUrl, apiToken, apiMethod, fetchParams,
...
export async function fetchBlobFromApi(apiUrl, apiToken, apiMethod, fetchParams,
                                       apiVersion="v1", urlSearchParams="") {
  let headers = new Headers()
  // headers.append('Content-Type', mimetype);
  // headers.append('Accept', mimetype);
  headers.append("Authorization", `Bearer ${apiToken}`)
